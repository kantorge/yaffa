...
class InvestmentApiControllerTest extends TestCase
{
    ...
    private function createInvestmentsForSortingTests(): User
    {
        /** @var User $user */
        $user = User::factory()->create();
        $this->createForUser($user, Currency::class);
    ...
    public function test_investment_list_default_sort_is_by_name_ascending(): void
    {
        $user = $this->createInvestmentsForSortingTests();
    ...
    public function test_investment_list_supports_sorting_by_name_descending(): void
    {
        $user = $this->createInvestmentsForSortingTests();
    ...
    public function test_investment_list_supports_sorting_by_symbol(): void
    {
        $user = $this->createInvestmentsForSortingTests();
    ...
    public function test_investment_list_supports_sorting_by_isin(): void
    {
        $user = $this->createInvestmentsForSortingTests();
    ...
    public function test_investment_list_supports_sorting_by_active_status(): void
    {
        $user = $this->createInvestmentsForSortingTests();
    ...
    public function test_investment_list_sort_by_falls_back_to_name_for_invalid_column(): void
    {
        $user = $this->createInvestmentsForSortingTests();
    ...
    public function test_investment_list_sort_order_falls_back_to_asc_for_invalid_value(): void
    {
        $user = $this->createInvestmentsForSortingTests();
    ...
    public function test_investment_list_sort_order_is_case_insensitive(): void
    {
        $user = $this->createInvestmentsForSortingTests();
    ...
    public function test_investment_list_sort_by_rejects_sql_injection_attempt(): void
    {
        $user = $this->createInvestmentsForSortingTests();
