...
test('password change client side validations', function () {
    // Make sure the sandbox mode is disabled
    // This ensures that the client is allowed to change the password
