...
test('user can load the investment transaction details', function () {
 ...
 */
test('user can load the dividend transaction details', function () {
    $user = User::firstWhere('email', $this::USER_EMAIL);
 ...
 **/
test('user can load the investment transaction details for a scheduled transaction', function () {
    $user = User::firstWhere('email', $this::USER_EMAIL);
