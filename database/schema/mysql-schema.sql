...
CREATE TABLE `account_entities` (
  ...
  `config_type` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `accounts` (
  ...
  `default_date_range` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `categories` (
  ...
  `default_aggregation` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'month',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `flags` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `flaggable_type` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `investments` (
  ...
  `investment_price_provider` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `investment_group_id` bigint unsigned NOT NULL,
  `currency_id` bigint unsigned NOT NULL,
  `scrape_url` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `scrape_selector` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `users` (
  ...
  `locale` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'en-EN',
  `start_date` date NOT NULL DEFAULT ((now() - interval 30 day)),
  `end_date` date NOT NULL DEFAULT ((now() + interval 50 year)),
  `account_details_date_range` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'none',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
