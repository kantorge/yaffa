...
namespace Biscolab\ReCaptcha\Facades {
    ...
    class ReCaptcha
    {
         ...
         * @static
         */
        public static function htmlFormButton($button_label = 'Submit', $properties = [])
        {
            /** @var \Biscolab\ReCaptcha\ReCaptchaBuilderInvisible $instance */
            return $instance->htmlFormButton($button_label, $properties);
        }
        /**
...
namespace Kantorge\CurrencyExchangeRates\Facades {
    ...
    class CurrencyExchangeRates
    {
         ...
         * @return \Kantorge\CurrencyExchangeRates\ApiClients\ExchangeRateApiClientInterface The created instance of the Currency Exchange Rates.
         * @throws \Exception If an invalid client type is specified.
         * @static
         */
        public static function create($type = null)
        {
            return \Kantorge\CurrencyExchangeRates\CurrencyExchangeRateApiClientFactory::create($type);
        }
...
namespace Laracasts\Utilities\JavaScript {
    ...
    class JavaScriptFacade
    {
        ...
        {
            /** @var Transformers\Transformer $instance */
            return $instance->put();
        }
        /**
...
namespace Laravel\Dusk {
    ...
    class Browser
    {
        ...
        {
            return Browser::select2($field, $value, $wait, $suffix);
        }
        /**
         *
         *
        ...
        {
            return Browser::select2ExactSearch($field, $value, $wait, $suffix);
        }
        /**
        ...
        {
            return Browser::select2ClearAll($field, $outerSelector, $suffix);
        }
...
namespace Illuminate\Console\Scheduling {
    ...
    class Event
    {
        ...
        {
            return Event::sentryMonitor($monitorSlug, $checkInMargin, $maxRuntime, $updateMonitorConfig);
        }
