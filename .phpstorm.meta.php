...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'ai-documents.ocr.tesseract_path' => 'string',
...
'ai-documents.file_upload.max_total_size_mb','ai-documents.file_upload.allowed_types','ai-documents.file_retention.retention_days','ai-documents.processing.max_retries','ai-documents.processing.retry_delay_seconds',
...
'ai-documents.google_drive.enabled','ai-documents.google_drive.sync_interval_minutes','ai-documents.google_drive.scopes','ai-documents.providers.openai.name','ai-documents.providers.openai.models',
'ai-documents.providers.openai.default_model','ai-documents.providers.gemini.name','ai-documents.providers.gemini.models','ai-documents.providers.gemini.default_model','ai-documents.image_processing.max_width',
'ai-documents.image_processing.max_height','ai-documents.image_processing.quality','app.name','app.env','app.debug',
...
'app.aliases.URL','app.aliases.Validator','app.aliases.View','app.aliases.Vite','app.aliases.Redis',
'app.available_languages.en','app.available_languages.hu','app.available_languages.fr','app.available_locales.en-US','app.available_locales.hu-HU',
'app.available_locales.fr-FR','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider',
...
'auth.passwords.users.throttle','auth.password_timeout','database.default','database.connections.sqlite.driver','database.connections.sqlite.url',
...
'database.connections.pgsql.sslmode','database.connections.pgsql.search_path','database.connections.sqlsrv.driver','database.connections.sqlsrv.url','database.connections.sqlsrv.host',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/gergo/yaffa/public/storage','filesystems.cloud','javascript.bind_js_vars_to_this_view',
...
'services.mailgun.endpoint','telescope.enabled','telescope.domain','telescope.path','telescope.driver',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\CacheWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ClientRequestWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\CommandWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\CommandWatcher.ignore','telescope.watchers.Laravel\\Telescope\\Watchers\\DumpWatcher',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\GateWatcher.ignore_packages','telescope.watchers.Laravel\\Telescope\\Watchers\\JobWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\LogWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\MailWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ModelWatcher.enabled',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\QueryWatcher.slow','telescope.watchers.Laravel\\Telescope\\Watchers\\RedisWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.size_limit','telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher',
'telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','translation_sheet.googleApplicationName','translation_sheet.serviceAccountEmail','translation_sheet.serviceAccountCredentialsFile','translation_sheet.spreadsheetId',
'translation_sheet.locales','translation_sheet.exclude','translation_sheet.primary_sheet.name','translation_sheet.extra_sheets','translation_sheet.skip_empty_for_php',
'trustedproxy.proxies','yaffa.version','yaffa.admin_email','yaffa.alpha_vantage_key','yaffa.registered_user_limit',
'yaffa.incoming_receipts_email','yaffa.email_verification_required','yaffa.runs_scheduler','yaffa.sandbox_mode','yaffa.gtm_container_id',
'yaffa.cookieyes_id','yaffa.account_date_presets.0.label','yaffa.account_date_presets.0.options.0.value','yaffa.account_date_presets.0.options.0.label','yaffa.account_date_presets.0.options.1.value',
'yaffa.account_date_presets.0.options.1.label','yaffa.account_date_presets.0.options.2.value','yaffa.account_date_presets.0.options.2.label','yaffa.account_date_presets.0.options.3.value','yaffa.account_date_presets.0.options.3.label',
'yaffa.account_date_presets.0.options.4.value','yaffa.account_date_presets.0.options.4.label','yaffa.account_date_presets.0.options.5.value','yaffa.account_date_presets.0.options.5.label','yaffa.account_date_presets.1.label',
'yaffa.account_date_presets.1.options.0.value','yaffa.account_date_presets.1.options.0.label','yaffa.account_date_presets.1.options.1.value','yaffa.account_date_presets.1.options.1.label','yaffa.account_date_presets.1.options.2.value',
'yaffa.account_date_presets.1.options.2.label','yaffa.account_date_presets.1.options.3.value','yaffa.account_date_presets.1.options.3.label','yaffa.account_date_presets.1.options.4.value','yaffa.account_date_presets.1.options.4.label',
'yaffa.account_date_presets.1.options.5.value','yaffa.account_date_presets.1.options.5.label','yaffa.account_date_presets.2.label','yaffa.account_date_presets.2.options.0.value','yaffa.account_date_presets.2.options.0.label',
'yaffa.account_date_presets.2.options.1.value','yaffa.account_date_presets.2.options.1.label','currency-exchange-rates.cache_prefix','currency-exchange-rates.default_provider','currency-exchange-rates.frankfurter.cache_ttl',
...
'boost.executable_paths.vendor_bin','mcp.redirect_domains','prism.prism_server.middleware','prism.prism_server.enabled','prism.request_timeout',
...
'prism.providers.openrouter.url','prism.providers.openrouter.site.http_referer','prism.providers.openrouter.site.x_title','roach.request_queue','roach.client',
...
'investment.update','investment.destroy','investment-price.list','tag.index','tag.create',
'tag.store','tag.edit','tag.update','tag.destroy','transaction.create',
'transaction.open','transactions.skipScheduleInstance','transactions.createFromDraft','transactions.destroy','reports.cashflow',
'reports.budgetchart','report.schedules','reports.transactions','reports.investment_timeline','received-mail.index',
...
'emails.transaction-error-from-email','import.csv','investment-group.form','investment-group.index','investment-prices.list',
'investment.form','investment.index','investment.show','pages.dashboard','pages.sandbox-terms',
'payee.form','payee.index','payee.merge','received-mail.index','received-mail.show',
'reports.budgetchart','reports.cashflow','reports.investment-timeline','reports.schedule','reports.transactions',
'search.search','tag.form','tag.index','template.components.flag-bar','template.components.footer',
'template.components.model-delete-form','template.components.navigation','template.components.notifications','template.components.quick-actions','template.components.tablefilter-sidebar-budget-account',
'template.components.tablefilter-sidebar-category-parent','template.components.tablefilter-sidebar-search','template.components.tablefilter-sidebar-transaction-type','template.components.transaction-skip-form','template.layouts.auth',
'template.layouts.page','template.master','template.sandbox-components.body-close','template.sandbox-components.head','template.sandbox-components.login-helper',
'template.sandbox-components.reset-alert','transactions.form','transactions.show','user.settings','breadcrumbs::bootstrap4',
'breadcrumbs::bootstrap5','breadcrumbs::bulma','breadcrumbs::foundation6','breadcrumbs::materialize','breadcrumbs::tailwind',
'breadcrumbs::uikit','duskapiconf::data','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
