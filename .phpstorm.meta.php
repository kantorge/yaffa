...
'app.aliases.Redis','app.available_languages.en','app.available_languages.fr','app.available_languages.hu','app.available_languages.pl',
'app.available_locales.en-US','app.available_locales.fr-FR','app.available_locales.hu-HU','app.available_locales.pl-PL','auth.defaults.guard',
...
'database.connections.pgsql.prefix','database.connections.pgsql.prefix_indexes','database.connections.pgsql.schema','database.connections.pgsql.sslmode','database.connections.pgsql.search_path',
...
'filesystems.links./home/gergo/yaffa/public/storage','filesystems.cloud','javascript.bind_js_vars_to_this_view','javascript.js_namespace','laravel-translatable-string-exporter.directories',
...
'services.mailgun.secret','services.mailgun.endpoint','telescope.enabled','telescope.domain','telescope.path',
...
'yaffa.registered_user_limit','yaffa.incoming_receipts_email','yaffa.email_verification_required','yaffa.runs_scheduler','yaffa.sandbox_mode',
'yaffa.gtm_container_id','yaffa.cookieyes_id','yaffa.account_date_presets.0.label','yaffa.account_date_presets.0.options.0.value','yaffa.account_date_presets.0.options.0.label',
'yaffa.account_date_presets.0.options.1.value','yaffa.account_date_presets.0.options.1.label','yaffa.account_date_presets.0.options.2.value','yaffa.account_date_presets.0.options.2.label','yaffa.account_date_presets.0.options.3.value',
'yaffa.account_date_presets.0.options.3.label','yaffa.account_date_presets.0.options.4.value','yaffa.account_date_presets.0.options.4.label','yaffa.account_date_presets.0.options.5.value','yaffa.account_date_presets.0.options.5.label',
'yaffa.account_date_presets.1.label','yaffa.account_date_presets.1.options.0.value','yaffa.account_date_presets.1.options.0.label','yaffa.account_date_presets.1.options.1.value','yaffa.account_date_presets.1.options.1.label',
'yaffa.account_date_presets.1.options.2.value','yaffa.account_date_presets.1.options.2.label','yaffa.account_date_presets.1.options.3.value','yaffa.account_date_presets.1.options.3.label','yaffa.account_date_presets.1.options.4.value',
'yaffa.account_date_presets.1.options.4.label','yaffa.account_date_presets.1.options.5.value','yaffa.account_date_presets.1.options.5.label','yaffa.account_date_presets.2.label','yaffa.account_date_presets.2.options.0.value',
'yaffa.account_date_presets.2.options.0.label','yaffa.account_date_presets.2.options.1.value','yaffa.account_date_presets.2.options.1.label','currency-exchange-rates.cache_prefix','currency-exchange-rates.default_provider',
...
'boost.executable_paths.npm','boost.executable_paths.vendor_bin','boost.executable_paths.current_directory','mcp.redirect_domains','roach.request_queue',
...
'api.accountentity.destroy','api.accountgroup.destroy','api.category.store',
...
'investment.getDetails','api.investment.destroy','api.investment.updateActive','api.investmentgroup.destroy',
'api.investment-price.index','api.investment-price.store','api.investment-price.update','api.investment-price.destroy','api.investment-price.retrieveMissing',
'api.investment-price.checkPrice','api.payee.store','api.payee.similar',
'api.tag.updateActive','api.reports.budgetchart','api.reports.cashflow','api.received-mail.reset-processed',
'api.received-mail.destroy','api.transactions.getScheduledItems','api.transactions.storeStandard','api.transactions.storeInvestment',
'api.transactions.updateStandard','api.transactions.updateInvestment','api.transactions.skipScheduleInstance',
'api.transactions.destroy','user.settings.update',
'user.change_password','home','terms','account-group.index',
'account-group.create','account-group.store','account-group.edit','account-group.update','account-group.destroy',
'account-entity.index','account-entity.create','account-entity.store','account-entity.show','account-entity.edit',
'account-entity.update','account.history','payees.merge.form','payees.merge.submit','categories.index',
'categories.create','categories.store','categories.edit','categories.update','categories.destroy',
'categories.merge.form','categories.merge.submit','currency.index','currency.create','currency.store',
'currency.edit','currency.update','currency.destroy','currency.setDefault','currency-rate.index',
'investment-group.index','investment-group.create','investment-group.store','investment-group.edit','investment-group.update',
'investment-group.destroy','investment.index','investment.create','investment.store','investment.show',
'investment.edit','investment.update','investment.destroy','investment-price.list','tag.index',
...
'password.confirm','verification.notice','verification.verify','verification.send','storage.local','storage.local.upload',);
