...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\thean\Herd\jaffa\public\storage' => 'string',
            ...
            'mailbox.basic_auth.password' => 'string',
            ...
            'services.companies_house.api_key' => 'string',
            ...
            'yaffa.gmail.enabled' => 'boolean',
            'yaffa.gmail.client_id' => 'string',
            'yaffa.gmail.client_secret' => 'string',
            'yaffa.gmail.refresh_token' => 'string',
            'yaffa.gmail.user_email' => 'string',
            'yaffa.gmail.whitelist' => 'array',
            'yaffa.sandbox_mode' => 'boolean',
            'yaffa.gtm_container_id' => 'string',
            'yaffa.cookieyes_id' => 'string',
            'yaffa.nlp_service_url' => 'string',
            'yaffa.nlp_service_timeout' => 'integer',
...
'logging.channels.sentry.driver','logging.channels.sentry_logs.driver','logging.channels.sentry_logs.level','logging.channels.deprecations.driver','logging.channels.deprecations.handler',
'logging.channels.browser.driver','logging.channels.browser.path','logging.channels.browser.level','logging.channels.browser.days','queue.default',
...
'app.aliases.Redis','app.available_languages.en','app.available_languages.hu','app.available_locales.en-US','app.available_locales.hu-HU',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\thean\\Herd\\jaffa\\public\\storage',
'filesystems.cloud','insights.preset','insights.ide','insights.exclude','insights.add.NunoMaduro\\PhpInsights\\Domain\\Metrics\\Architecture\\Classes',
'insights.remove','insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\ForbiddenPrivateMethods.title','insights.requirements','insights.threads','javascript.bind_js_vars_to_this_view',
'javascript.js_namespace','laravel-translatable-string-exporter.directories','laravel-translatable-string-exporter.excluded-directories','laravel-translatable-string-exporter.patterns','laravel-translatable-string-exporter.allow-newlines',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','mailbox.driver',
'mailbox.model','mailbox.path','mailbox.store_incoming_emails_for_days','mailbox.only_store_matching_emails','mailbox.basic_auth.username',
'mailbox.basic_auth.password','mailbox.services.mailgun.key','openai.api_key','openai.organization','recaptcha.api_site_key',
...
'services.mailgun.endpoint','services.companies_house.api_key','telescope.enabled','telescope.domain','telescope.path',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','translation_sheet.googleApplicationName','translation_sheet.serviceAccountEmail','translation_sheet.serviceAccountCredentialsFile',
'translation_sheet.spreadsheetId','translation_sheet.locales','translation_sheet.exclude','translation_sheet.primary_sheet.name','translation_sheet.extra_sheets',
'translation_sheet.skip_empty_for_php','trustedproxy.proxies','yaffa.version','yaffa.admin_email','yaffa.alpha_vantage_key',
'yaffa.registered_user_limit','yaffa.incoming_receipts_email','yaffa.email_verification_required','yaffa.runs_scheduler','yaffa.gmail.enabled',
'yaffa.gmail.client_id','yaffa.gmail.client_secret','yaffa.gmail.refresh_token','yaffa.gmail.user_email','yaffa.gmail.whitelist',
'yaffa.sandbox_mode','yaffa.gtm_container_id','yaffa.cookieyes_id','yaffa.nlp_service_url','yaffa.nlp_service_timeout',
...
'yaffa.account_date_presets.2.options.1.label','currency-exchange-rates.cache_prefix','currency-exchange-rates.default_provider','currency-exchange-rates.frankfurter.cache_ttl','boost.enabled',
'boost.browser_logs_watcher','mcp.redirect_domains','roach.request_queue','roach.client','roach.default_spider_namespace',
'model-flags.flag_model','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'debugbar.telescope','debugbar.assets.css','debugbar.assets.js','debugbar.cache.delete','debugbar.queries.explain','boost.browser-logs','dusk.login','dusk.logout',
'dusk.user','sanctum.csrf-cookie','api.account.updateMonthlySummary','api.accountentity.updateActive','api.accountentity.destroy','api.accountgroup.destroy','api.category.updateActive','api.category.destroy',
'api.currency-rate.index','api.currency-rate.store','api.currency-rate.update','api.currency-rate.destroy','api.currency-rate.retrieveMissing','investment.getDetails','api.investment.destroy','api.investment.updateActive','api.investmentgroup.destroy','api.payee.store',
'api.payee.similar','api.tag.updateActive','api.reports.budgetchart',
'api.reports.cashflow','api.received-mail.reset-processed','api.received-mail.destroy','api.transactions.getScheduledItems',
'api.transactions.storeStandard','api.transactions.storeInvestment','api.transactions.updateStandard','api.transactions.updateInvestment','api.transactions.skipScheduleInstance','api.transactions.destroy','user.settings.update',
'user.change_password','investment.upload_csv','investment.upload_statements',
'investment.upload_statements.handle','investment.upload_statement','payslip.upload','payslip.upload.handle',
'imports.status','imports.errors','imports.index','home','terms',
'account-group.index','account-group.create','account-group.store','account-group.edit','account-group.update',
'account-group.destroy','account-entity.index','account-entity.create','account-entity.store','account-entity.show',
'account-entity.edit','account-entity.update','account-entity.transactions','account.history','account.batch-entry.investment',
'account.batch-entry.investment.store','account.batch-reconcile.investment','account.batch-reconcile.investment.store','account.batch-reconcile.investment.quantities','payees.merge.form',
'payees.merge.submit','categories.index','categories.create','categories.store','categories.edit',
'categories.update','categories.destroy','categories.merge.form','categories.merge.submit','currency.index',
'currency.create','currency.store','currency.edit','currency.update','currency.destroy',
'currency.setDefault','currency-rate.index','investment-group.index','investment-group.create','investment-group.store',
'investment-group.edit','investment-group.update','investment-group.destroy','investment.upload','import.moneyhub',
'import.moneyhub.upload','investment.interest','investment.index','investment.create','investment.store',
'investment.show','investment.edit','investment.update','investment.destroy','investment-price.list',
'investment-price.importFromTrades','investment-price.retrieve','investment-price.create','investment-price.store','investment-price.edit',
'investment-price.update','investment-price.destroy','tag.index','tag.create','tag.store',
'tag.edit','tag.update','tag.destroy','transaction-import-rules.index','transaction-import-rules.create',
'transaction-import-rules.store','transaction-import-rules.edit','transaction-import-rules.update','transaction-import-rules.destroy','transaction-import-rules.test',
'transaction-import-rules.apply','transaction.create','transaction.open','transactions.skipScheduleInstance','transactions.createFromDraft',
'transactions.destroy','reports.cashflow','reports.budgetchart','report.schedules','reports.transactions',
'reports.investment_timeline','reports.unrealised_interest','reports.tax','reports.tax.export','received-mail.index',
'received-mail.show','received-mail.destroy','received-mail.upload-pdf','search','import.csv',
'import.csv.upload','user.settings','login','logout',
...
'emails.transaction-error-from-email','import.csv','import.index','import.moneyhub','investment-group.form',
'investment-group.index','investment-prices.form','investment-prices.list','investment.form','investment.index',
'investment.interest','investment.show','investment.upload','investment.upload_csv','investment.upload_csv_plain',
'investment.upload_statements','pages.dashboard','pages.sandbox-terms','payee.form','payee.index',
'payee.merge','payslip.upload','received-mail.index','received-mail.show','reports.budgetchart',
'reports.cashflow','reports.investment-timeline','reports.schedule','reports.tax','reports.transactions',
'reports.unrealised-interest','search.search','tag.form','tag.index','template.components.flag-bar',
...
'template.sandbox-components.login-helper','template.sandbox-components.reset-alert','transaction-import-rules.form','transaction-import-rules.index','transaction-import-rules.test',
'transactions.batch-entry-investment','transactions.batch-reconcile-investment','transactions.form','transactions.show','user.settings',
...
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.Users.thean.Herd.jaffa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name','default_assets.account_groups.bank_accounts','default_assets.account_groups.cash','default_assets.account_groups.credits','default_assets.account_groups.loans',
...
'default_assets.investment_groups.other','default_assets.investment_groups.stocks','default_assets.tags.todo','validation.accepted','validation.active_url',
'validation.after','validation.after_or_equal','validation.alpha','validation.alpha_dash','validation.alpha_num',
'validation.array','validation.attributes.config.opening_balance','validation.attributes.name','validation.attributes.tos','validation.before',
...
'validation.digits','validation.digits_between','validation.dimensions','validation.email','validation.ends_with',
'validation.file','validation.gt.array','validation.gt.file','validation.gt.numeric','validation.gt.string',
...
'validation.lte.array','validation.lte.file','validation.lte.numeric','validation.lte.string','validation.max.array',
'validation.max.file','validation.max.numeric','validation.max.string','validation.mimes','validation.mimetypes',
'validation.min.array','validation.min.file','validation.min.numeric','validation.min.string','validation.not_regex',
'validation.numeric','validation.password','validation.regex','validation.same','validation.size.array',
'validation.size.file','validation.size.numeric','validation.size.string','validation.starts_with','validation.string',
'validation.timezone','validation.url','validation.uuid','auth.failed','pagination.next',
'pagination.previous','passwords.reset','passwords.sent','passwords.throttled','passwords.token',
'passwords.user','validation.required',);
        registerArgumentsSet('env', 
'APP_KEY','DB_CONNECTION','DB_HOST','DB_PORT','DB_DATABASE',
'DB_USERNAME','DB_PASSWORD','DB_SOCKET','REGISTERED_USER_LIMIT','EMAIL_VERIFICATION_REQUIRED',
'ADMIN_EMAIL','MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME',
'MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','APP_URL',
'ALPHA_VANTAGE_KEY','MAILBOX_DRIVER','MAILBOX_HTTP_PASSWORD','INCOMING_RECEIPTS_EMAIL','OPENAI_API_KEY',
'APP_NAME','APP_ENV','APP_DEBUG','LOG_CHANNEL','LOG_LEVEL',
'BROADCAST_DRIVER','QUEUE_CONNECTION','ENLIGHTN_USERNAME','ENLIGHTN_API_TOKEN','SENTRY_LARAVEL_DSN',
'SENTRY_TRACES_SAMPLE_RATE','SANDBOX_MODE','RECAPTCHA_SITE_KEY','RECAPTCHA_SECRET_KEY','GTM_CONTAINER_ID',
'COOKIEYES_ID','TS_SERVICE_ACCOUNT_EMAIL','TS_SERVICE_ACCOUNT_CREDENTIALS_FILE','TS_SPREADSHEET_ID','TS_LOCALES',
'WWWGROUP','WWWUSER','APP_SERVICE','SAIL_XDEBUG_ENABLED','SAIL_XDEBUG_PORT',
'SAIL_XDEBUG_MODE','SAIL_XDEBUG_CONFIG','SERVER_NAME','SSL_DOMAIN','TELESCOPE_ENABLED',
'DEBUGBAR_ENABLED','DEBUGBAR_OPEN_STORAGE','GMAIL_CLIENT_ID','GMAIL_CLIENT_SECRET','GMAIL_REFRESH_TOKEN',
'GMAIL_API_ENABLED','GMAIL_USER_EMAIL','GMAIL_SENDER_WHITELIST','COMPANIES_HOUSE_API_KEY','NLP_SERVICE_URL',);
