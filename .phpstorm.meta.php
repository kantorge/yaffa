...
'app.available_languages.hu','app.available_locales.en-US','app.available_locales.hu-HU','auth.defaults.guard','auth.defaults.passwords',
...
'filesystems.disks.s3.report','filesystems.links./home/gergo/yaffa/public/storage','filesystems.cloud','insights.preset','insights.ide',
...
'insights.threads','javascript.bind_js_vars_to_this_view','javascript.js_namespace','laravel-translatable-string-exporter.directories','laravel-translatable-string-exporter.excluded-directories',
...
'ASSET_URL','APP_SERVICE','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
'APP_MAINTENANCE_DRIVER','APP_MAINTENANCE_STORE','BCRYPT_ROUNDS','ALPHA_VANTAGE_KEY','LOG_CHANNEL',
'LOG_STACK','LOG_LEVEL','DEBUGBAR_ENABLED','DEBUGBAR_OPEN_STORAGE','SAIL_XDEBUG_ENABLED',
...
'INCOMING_RECEIPTS_EMAIL','OPENAI_API_KEY','TS_SERVICE_ACCOUNT_EMAIL','TS_SERVICE_ACCOUNT_CREDENTIALS_FILE','TS_SPREADSHEET_ID',
'TS_LOCALES','WWWGROUP','WWWUSER','SENTRY_LARAVEL_DSN','SENTRY_TRACES_SAMPLE_RATE',
