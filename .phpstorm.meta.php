...
'cache.stores.dynamodb.endpoint','cache.stores.octane.driver','cache.stores.failover.driver','cache.stores.failover.stores','cache.stores.|-microscope-|.driver',
'cache.stores.|-microscope-|.path','cache.prefix','view.paths','view.compiled','hashing.driver',
...
'logging.channels.browser.path','logging.channels.browser.level','logging.channels.browser.days','app.name','app.env',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/gergo/yaffa/public/storage','filesystems.cloud',
'insights.preset','insights.ide','insights.exclude','insights.add.NunoMaduro\\PhpInsights\\Domain\\Metrics\\Architecture\\Classes','insights.remove',
'insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\ForbiddenPrivateMethods.title','insights.requirements','insights.threads','javascript.bind_js_vars_to_this_view','javascript.js_namespace',
...
'mailbox.services.mailgun.key','openai.api_key','openai.organization','recaptcha.api_site_key','recaptcha.api_secret_key',
...
'sanctum.token_prefix','sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','sentry.dsn',
...
'telescope.only_paths','telescope.ignore_paths','telescope.ignore_commands','telescope.watchers.Laravel\\Telescope\\Watchers\\BatchWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\CacheWatcher',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ModelWatcher.hydrations','telescope.watchers.Laravel\\Telescope\\Watchers\\NotificationWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\QueryWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\QueryWatcher.ignore_packages','telescope.watchers.Laravel\\Telescope\\Watchers\\QueryWatcher.slow',
'telescope.watchers.Laravel\\Telescope\\Watchers\\RedisWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.size_limit','telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher',
...
'laravel-exceptions::503','laravel-exceptions::layout','laravel-exceptions::minimal','microscope_package::actions_comment','notifications::email',
...
'APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','APP_MAINTENANCE_STORE','BCRYPT_ROUNDS','ALPHA_VANTAGE_KEY',
'LOG_CHANNEL','LOG_STACK','LOG_LEVEL','DEBUGBAR_ENABLED','DEBUGBAR_OPEN_STORAGE',
'SAIL_XDEBUG_ENABLED','SAIL_XDEBUG_PORT','SAIL_XDEBUG_MODE','SAIL_XDEBUG_CONFIG','TELESCOPE_ENABLED',
'DB_CONNECTION','DB_HOST','DB_PORT','DB_DATABASE','DB_USERNAME',
'DB_PASSWORD','BROADCAST_CONNECTION','CACHE_STORE','QUEUE_CONNECTION','SESSION_DRIVER',
'SESSION_LIFETIME','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','RUNS_SCHEDULER',
'MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD',
'MAIL_SCHEME','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','REGISTERED_USER_LIMIT','EMAIL_VERIFICATION_REQUIRED',
'ADMIN_EMAIL','INCOMING_RECEIPTS_EMAIL','OPENAI_API_KEY','TS_SERVICE_ACCOUNT_EMAIL','TS_SERVICE_ACCOUNT_CREDENTIALS_FILE',
'TS_SPREADSHEET_ID','TS_LOCALES','WWWGROUP','WWWUSER','SENTRY_LARAVEL_DSN',
