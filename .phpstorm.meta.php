...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'enlightn.allowed_permissions./home/gergo/yaffa' => 'string',
            'enlightn.allowed_permissions./home/gergo/yaffa/app' => 'string',
            'enlightn.allowed_permissions./home/gergo/yaffa/resources' => 'string',
            'enlightn.allowed_permissions./home/gergo/yaffa/storage' => 'string',
            'enlightn.allowed_permissions./home/gergo/yaffa/public' => 'string',
            'enlightn.allowed_permissions./home/gergo/yaffa/config' => 'string',
            'enlightn.allowed_permissions./home/gergo/yaffa/database' => 'string',
            'enlightn.allowed_permissions./home/gergo/yaffa/routes' => 'string',
            'enlightn.allowed_permissions./home/gergo/yaffa/bootstrap' => 'string',
            'enlightn.allowed_permissions./home/gergo/yaffa/bootstrap/cache' => 'string',
            'enlightn.allowed_permissions./home/gergo/yaffa/bootstrap/app.php' => 'string',
            'enlightn.allowed_permissions./home/gergo/yaffa/artisan' => 'string',
            'enlightn.allowed_permissions./home/gergo/yaffa/public/index.php' => 'string',
            'enlightn.allowed_permissions./home/gergo/yaffa/public/server.php' => 'string',
...
'cache.stores.dynamodb.endpoint','cache.stores.octane.driver','cache.stores.|-microscope-|.driver','cache.stores.|-microscope-|.path','cache.prefix',
...
'logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','app.name','app.env',
...
'app.aliases.Uri','app.aliases.Validator','app.aliases.View','app.aliases.Vite','app.aliases.Redis',
'app.available_languages.en','app.available_languages.hu','app.available_locales.en-US','app.available_locales.hu-HU','auth.defaults.guard',
...
'debugbar.route_domain','debugbar.theme','debugbar.debug_backtrace_limit','enlightn.analyzers','enlightn.exclude_analyzers',
...
'enlightn.credentials.api_token','enlightn.github_repo','enlightn.compact_lines','enlightn.commercial_packages','enlightn.allowed_permissions./home/gergo/yaffa',
'enlightn.allowed_permissions./home/gergo/yaffa/app','enlightn.allowed_permissions./home/gergo/yaffa/resources','enlightn.allowed_permissions./home/gergo/yaffa/storage','enlightn.allowed_permissions./home/gergo/yaffa/public','enlightn.allowed_permissions./home/gergo/yaffa/config',
'enlightn.allowed_permissions./home/gergo/yaffa/database','enlightn.allowed_permissions./home/gergo/yaffa/routes','enlightn.allowed_permissions./home/gergo/yaffa/bootstrap','enlightn.allowed_permissions./home/gergo/yaffa/bootstrap/cache','enlightn.allowed_permissions./home/gergo/yaffa/bootstrap/app.php',
'enlightn.allowed_permissions./home/gergo/yaffa/artisan','enlightn.allowed_permissions./home/gergo/yaffa/public/index.php','enlightn.allowed_permissions./home/gergo/yaffa/public/server.php','enlightn.writable_directories','enlightn.phpstan.--error-format',
...
'breadcrumbs::tailwind','breadcrumbs::uikit','duskapiconf::data','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'validation.uuid','validation.custom.attribute-name.rule-name','default_assets.account_groups.bank_accounts','default_assets.account_groups.cash','default_assets.account_groups.credits',
'default_assets.account_groups.loans','default_assets.account_groups.savings_and_investments','default_assets.accounts.cash_reserve','default_assets.accounts.credit_card','default_assets.accounts.investment_account',
'default_assets.accounts.loan','default_assets.accounts.other_bank_account','default_assets.accounts.primary_bank_account','default_assets.accounts.wallet','default_assets.categories.bonuses',
'default_assets.categories.books_and_supplies','default_assets.categories.car_insurance','default_assets.categories.car_payments','default_assets.categories.child_allowance','default_assets.categories.clothing',
'default_assets.categories.courses_and_training','default_assets.categories.credit_card','default_assets.categories.debt_repayment','default_assets.categories.dining_out','default_assets.categories.disability_insurance',
'default_assets.categories.doctor_visits','default_assets.categories.education_and_development','default_assets.categories.electricity','default_assets.categories.entertainment','default_assets.categories.entertainment_and_leisure',
'default_assets.categories.events','default_assets.categories.fines','default_assets.categories.food','default_assets.categories.freelance_work','default_assets.categories.fuel',
'default_assets.categories.gas_and_heating','default_assets.categories.gifts_and_donations','default_assets.categories.government_benefits','default_assets.categories.groceries','default_assets.categories.health_insurance',
'default_assets.categories.healthcare','default_assets.categories.hobbies_and_activities','default_assets.categories.home_improvements','default_assets.categories.home_insurance','default_assets.categories.household_products',
'default_assets.categories.housing','default_assets.categories.insurance','default_assets.categories.internet_cable','default_assets.categories.legal_fees','default_assets.categories.life_insurance',
'default_assets.categories.loans','default_assets.categories.main_job','default_assets.categories.maintenance_and_repairs','default_assets.categories.medications','default_assets.categories.miscellaneous',
'default_assets.categories.mortgage_overpayments','default_assets.categories.other_income','default_assets.categories.parking','default_assets.categories.personal_care','default_assets.categories.personal_loans',
'default_assets.categories.pet_care','default_assets.categories.property_taxes','default_assets.categories.public_transport','default_assets.categories.rent','default_assets.categories.rent_and_mortgage',
'default_assets.categories.rental_income','default_assets.categories.repairs_maintenance','default_assets.categories.salary','default_assets.categories.school_and_university_fees','default_assets.categories.side_job',
'default_assets.categories.social_assistance','default_assets.categories.student_loans','default_assets.categories.subscriptions','default_assets.categories.transportation','default_assets.categories.utilities',
'default_assets.categories.vacation_and_travel','default_assets.categories.vehicle_maintenance','default_assets.categories.vision_and_dental_care','default_assets.categories.water','default_assets.categories.water_sewer',
'default_assets.investment_groups.bonds','default_assets.investment_groups.other','default_assets.investment_groups.stocks','default_assets.tags.todo','validation.attributes.config.opening_balance',
'validation.attributes.name','validation.attributes.tos','validation.password',);
