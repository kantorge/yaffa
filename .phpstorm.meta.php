...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'ai-documents.file_upload.max_files_per_submission' => 'integer',
            ...
            'ai-documents.processing.ai_temperature' => 'double',
            'ai-documents.processing.ai_top_p' => 'integer',
            'ai-documents.processing.ai_frequency_penalty' => 'integer',
            'ai-documents.processing.ai_presence_penalty' => 'integer',
            'ai-documents.asset_matching.similarity_threshold' => 'double',
            'ai-documents.asset_matching.max_suggestions' => 'integer',
            'ai-documents.duplicate_detection.date_window_days' => 'integer',
            'ai-documents.duplicate_detection.amount_tolerance_percent' => 'integer',
            'ai-documents.duplicate_detection.similarity_threshold' => 'double',
            'ai-documents.google_drive.enabled' => 'boolean',
            'ai-documents.google_drive.sync_interval_minutes' => 'string',
            'ai-documents.google_drive.scopes' => 'array',
            'ai-documents.providers.openai.name' => 'string',
            'ai-documents.providers.openai.models.gpt-4o.vision' => 'boolean',
            'ai-documents.providers.openai.models.gpt-4o-mini.vision' => 'boolean',
            'ai-documents.providers.openai.models.gpt-5-mini.vision' => 'boolean',
            'ai-documents.providers.gemini.name' => 'string',
            'ai-documents.providers.gemini.models.gemini-1.5-pro.vision' => 'boolean',
            'ai-documents.providers.gemini.models.gemini-1.5-flash.vision' => 'boolean',
            'ai-documents.ocr.tesseract_enabled' => 'boolean',
            'ai-documents.ocr.tesseract_mode' => 'string',
            'ai-documents.ocr.tesseract_language' => 'string',
            'ai-documents.ocr.tesseract_binary.path' => 'string',
            'ai-documents.ocr.tesseract_http.host' => 'string',
            'ai-documents.ocr.tesseract_http.port' => 'string',
            'ai-documents.ocr.tesseract_http.timeout' => 'string',
            'ai-documents.ocr.tesseract_http.endpoint' => 'string',
            ...
            'demo.ai_provider' => 'string',
            'demo.ai_model' => 'string',
            'demo.ai_api_key' => 'string',
            'demo.google_drive_folder_id' => 'string',
            'demo.google_drive_json_key_file' => 'string',
...
'logging.channels.browser.days','logging.channels.deprecations.driver','logging.channels.deprecations.handler','ai-documents.file_upload.max_files_per_submission','ai-documents.file_upload.max_file_size_mb',
'ai-documents.file_upload.max_total_size_mb','ai-documents.file_upload.allowed_types','ai-documents.local_storage_file_retention.retention_days','ai-documents.processing.max_retries','ai-documents.processing.retry_delay_seconds',
'ai-documents.processing.processing_timeout_seconds','ai-documents.processing.ai_temperature','ai-documents.processing.ai_top_p','ai-documents.processing.ai_frequency_penalty','ai-documents.processing.ai_presence_penalty',
'ai-documents.asset_matching.similarity_threshold','ai-documents.asset_matching.max_suggestions','ai-documents.duplicate_detection.date_window_days','ai-documents.duplicate_detection.amount_tolerance_percent','ai-documents.duplicate_detection.similarity_threshold',
'ai-documents.google_drive.enabled','ai-documents.google_drive.sync_interval_minutes','ai-documents.google_drive.scopes','ai-documents.providers.openai.name','ai-documents.providers.openai.models.gpt-4o.vision',
'ai-documents.providers.openai.models.gpt-4o-mini.vision','ai-documents.providers.openai.models.gpt-5-mini.vision','ai-documents.providers.gemini.name','ai-documents.providers.gemini.models.gemini-1.5-pro.vision','ai-documents.providers.gemini.models.gemini-1.5-flash.vision',
'ai-documents.ocr.tesseract_enabled','ai-documents.ocr.tesseract_mode','ai-documents.ocr.tesseract_language','ai-documents.ocr.tesseract_binary.path','ai-documents.ocr.tesseract_http.host',
'ai-documents.ocr.tesseract_http.port','ai-documents.ocr.tesseract_http.timeout','ai-documents.ocr.tesseract_http.endpoint','ai-documents.image_processing.max_width','ai-documents.image_processing.max_height',
'ai-documents.image_processing.quality','app.name','app.env','app.debug','app.url',
...
'debugbar.route_middleware','debugbar.route_domain','debugbar.theme','debugbar.debug_backtrace_limit','demo.ai_provider',
'demo.ai_model','demo.ai_api_key','demo.google_drive_folder_id','demo.google_drive_json_key_file','filesystems.default',
...
'filesystems.disks.s3.report','filesystems.links./home/gergo/yaffa/public/storage','filesystems.cloud','javascript.bind_js_vars_to_this_view','javascript.js_namespace',
'laravel-translatable-string-exporter.directories','laravel-translatable-string-exporter.excluded-directories','laravel-translatable-string-exporter.patterns','laravel-translatable-string-exporter.allow-newlines','laravel-translatable-string-exporter.functions',
'laravel-translatable-string-exporter.sort-keys','laravel-translatable-string-exporter.add-persistent-strings-to-translations','laravel-translatable-string-exporter.exclude-translation-keys','laravel-translatable-string-exporter.put-untranslated-strings-at-the-top','mail.default',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','mailbox.driver','mailbox.model',
'mailbox.path','mailbox.store_incoming_emails_for_days','mailbox.only_store_matching_emails','mailbox.basic_auth.username','mailbox.basic_auth.password',
'mailbox.services.mailgun.key','recaptcha.api_site_key','recaptcha.api_secret_key','recaptcha.version','recaptcha.curl_timeout',
...
'currency-exchange-rates.default_provider','currency-exchange-rates.frankfurter.cache_ttl','boost.enabled','boost.browser_logs_watcher','boost.executable_paths.php',
'boost.executable_paths.composer','boost.executable_paths.npm','boost.executable_paths.vendor_bin','mcp.redirect_domains','prism.prism_server.middleware',
...
'breadcrumbs.generator-class','tinker.commands','tinker.alias','tinker.dont_alias','tinker.trust_project',);
...
'api.accountentity.destroy','api.accountgroup.destroy','api.category.updateActive','api.category.destroy','api.currency-rate.index','api.currency-rate.store','api.currency-rate.update',
'api.currency-rate.destroy','api.currency-rate.retrieveMissing','investment.getDetails',
'api.investment.destroy','api.investment.updateActive','api.investmentgroup.destroy','api.investment-price.index',
'api.investment-price.store','api.investment-price.update','api.investment-price.destroy','api.investment-price.retrieveMissing','api.investment-price.checkPrice','api.payee.store','api.payee.similar','api.tag.updateActive',
'api.reports.budgetchart','api.reports.cashflow','api.transactions.getScheduledItems',
'api.transactions.storeStandard','api.transactions.storeInvestment','api.transactions.updateStandard','api.transactions.updateInvestment','api.transactions.skipScheduleInstance','api.transactions.destroy','user.settings.update','user.change_password','api.user.preference.get','api.user.preference.set',
'api.documents.store','api.documents.index','api.documents.show','api.documents.update','api.documents.reprocess',
'api.documents.checkDuplicates','api.documents.destroy','api.ai.config.show','api.ai.config.store','api.ai.config.update',
'api.ai.config.destroy','api.ai.config.test','api.google-drive.config.show','api.google-drive.config.store','api.google-drive.config.update',
'api.google-drive.config.destroy','api.google-drive.config.test','api.google-drive.config.sync','api.payee-stats.category-stats',
'home','terms','account-group.index','account-group.create','account-group.store',
'account-group.edit','account-group.update','account-group.destroy','account-entity.index','account-entity.create',
'account-entity.store','account-entity.show','account-entity.edit','account-entity.update','account.history',
'payees.merge.form','payees.merge.submit','categories.index','categories.create','categories.store',
'categories.edit','categories.update','categories.destroy','categories.merge.form','categories.merge.submit',
'currency.index','currency.create','currency.store','currency.edit','currency.update',
'currency.destroy','currency.setDefault','currency-rate.index','investment-group.index','investment-group.create',
'investment-group.store','investment-group.edit','investment-group.update','investment-group.destroy','investment.index',
'investment.create','investment.store','investment.show','investment.edit','investment.update',
'investment.destroy','investment-price.list','tag.index','tag.create','tag.store',
'tag.edit','tag.update','tag.destroy','transaction.create','transaction.open',
'transactions.skipScheduleInstance','transactions.createFromDraft','transactions.destroy','reports.cashflow','reports.budgetchart',
'report.schedules','reports.transactions','reports.investment_timeline','search','import.csv',
'ai-documents.index','ai-documents.show','ai-documents.files.show','user.settings','login','logout','register','password.request',
...
'account.show','ai-documents.index','ai-documents.show','auth.components.email','auth.components.password',
'auth.components.password_confirmation','auth.login','auth.passwords.confirm','auth.passwords.email','auth.passwords.reset',
'auth.register','auth.verify','categories.form','categories.index','categories.merge',
'components.nav-link','components.tablefilter-sidebar-switch','currency-rate.index','currency.form','currency.index',
'emails.ai-document-processed','emails.ai-document-processing-failed','emails.testmail','emails.transaction-created-from-email','emails.transaction-error-from-email',
'import.csv','investment-group.form','investment-group.index','investment-prices.list','investment.form',
'investment.index','investment.show','pages.dashboard','pages.sandbox-terms','payee.form',
'payee.index','payee.merge','reports.budgetchart','reports.cashflow','reports.investment-timeline',
'reports.schedule','reports.transactions','search.search','tag.form','tag.index',
'template.components.flag-bar','template.components.footer','template.components.model-delete-form','template.components.navigation','template.components.notifications',
'template.components.quick-actions','template.components.tablefilter-sidebar-budget-account','template.components.tablefilter-sidebar-category-parent','template.components.tablefilter-sidebar-search','template.components.tablefilter-sidebar-transaction-type',
'template.components.transaction-skip-form','template.layouts.auth','template.layouts.page','template.master','template.sandbox-components.body-close',
'template.sandbox-components.head','template.sandbox-components.login-helper','template.sandbox-components.reset-alert','transactions.form','transactions.show',
'user.settings','breadcrumbs::bootstrap4','breadcrumbs::bootstrap5','breadcrumbs::bulma','breadcrumbs::foundation6',
'breadcrumbs::materialize','breadcrumbs::tailwind','breadcrumbs::uikit','duskapiconf::data','laravel-exceptions-renderer::components.badge',
...
'LOG_LEVEL','DEBUGBAR_ENABLED','DEBUGBAR_OPEN_STORAGE','DEBUGBAR_EDITOR','SAIL_XDEBUG_ENABLED',
'SAIL_XDEBUG_PORT','SAIL_XDEBUG_MODE','SAIL_XDEBUG_CONFIG','TELESCOPE_ENABLED','DB_CONNECTION',
'DB_HOST','DB_PORT','DB_DATABASE','DB_USERNAME','DB_PASSWORD',
'BROADCAST_CONNECTION','CACHE_STORE','QUEUE_CONNECTION','SESSION_DRIVER','SESSION_LIFETIME',
'REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','RUNS_SCHEDULER','MAIL_MAILER',
'MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD','MAIL_SCHEME',
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','REGISTERED_USER_LIMIT','EMAIL_VERIFICATION_REQUIRED','ADMIN_EMAIL',
'INCOMING_RECEIPTS_EMAIL','AI_GOOGLE_DRIVE_ENABLED','AI_GOOGLE_DRIVE_SYNC_INTERVAL_MINUTES','AI_DOCUMENT_ALLOWED_TYPES','TESSERACT_ENABLED',
'TESSERACT_MODE','TESSERACT_PATH','TESSERACT_LANGUAGE','TESSERACT_HTTP_HOST','TESSERACT_HTTP_PORT',
'TESSERACT_HTTP_TIMEOUT','TS_SERVICE_ACCOUNT_EMAIL','TS_SERVICE_ACCOUNT_CREDENTIALS_FILE','TS_SPREADSHEET_ID','TS_LOCALES',
'WWWGROUP','WWWUSER','SENTRY_LARAVEL_DSN','SENTRY_TRACES_SAMPLE_RATE','RECAPTCHA_SITE_KEY',
