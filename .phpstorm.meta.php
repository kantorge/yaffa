...
'debugbar.options.db.show_copy','debugbar.options.db.slow_threshold','debugbar.options.mail.full_log','debugbar.options.views.timeline','debugbar.options.views.data',
'debugbar.options.views.exclude_paths','debugbar.options.route.label','debugbar.options.logs.file','debugbar.options.cache.values','debugbar.inject',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/gergo/yaffa/public/storage','filesystems.cloud','insights.preset',
...
'insights.requirements','insights.threads','javascript.bind_js_vars_to_this_view','javascript.js_namespace','laravel-translatable-string-exporter.directories',
...
'laravel-translatable-string-exporter.add-persistent-strings-to-translations','laravel-translatable-string-exporter.exclude-translation-keys','laravel-translatable-string-exporter.put-untranslated-strings-at-the-top','mail.default','mail.mailers.smtp.transport',
...
'mail.markdown.theme','mail.markdown.paths','mailbox.driver','mailbox.model','mailbox.path',
'mailbox.store_incoming_emails_for_days','mailbox.only_store_matching_emails','mailbox.basic_auth.username','mailbox.basic_auth.password','mailbox.services.mailgun.key',
'openai.api_key','openai.organization','recaptcha.api_site_key','recaptcha.api_secret_key','recaptcha.version',
...
'sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','sentry.dsn','sentry.release',
...
'currency-exchange-rates.cache_prefix','currency-exchange-rates.default_provider','currency-exchange-rates.frankfurter.cache_ttl','boost.enabled','boost.browser_logs_watcher',
'mcp.redirect_domains','roach.request_queue','roach.client','roach.default_spider_namespace','model-flags.flag_model',
...
'TS_LOCALES','ANTHROPIC_API_KEY','WWWGROUP','WWWUSER','SENTRY_LARAVEL_DSN',
'SENTRY_TRACES_SAMPLE_RATE','RECAPTCHA_SITE_KEY','RECAPTCHA_SECRET_KEY','GTM_CONTAINER_ID','COOKIEYES_ID',
'SANDBOX_MODE','SERVER_NAME','SSL_DOMAIN','TRUSTED_PROXIES',);
