...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'ai-documents.providers.openai.supported' => 'boolean',
            'ai-documents.providers.openai.models.gpt-4o-mini.vision' => 'boolean',
            'ai-documents.providers.openai.models.gpt-4o-mini.supported' => 'boolean',
            'ai-documents.providers.openai.models.gpt-4o.vision' => 'boolean',
            'ai-documents.providers.openai.models.gpt-4o.supported' => 'boolean',
            'ai-documents.providers.gemini.name' => 'string',
            'ai-documents.providers.gemini.supported' => 'boolean',
            'ai-documents.providers.gemini.models.gemini-2.5-flash.vision' => 'boolean',
            'ai-documents.providers.gemini.models.gemini-2.5-flash.supported' => 'boolean',
            'ai-documents.providers.gemini.models.gemini-2.5-pro.vision' => 'boolean',
            'ai-documents.providers.gemini.models.gemini-2.5-pro.supported' => 'boolean',
...
'ai-documents.file_upload.allowed_types','ai-documents.local_storage_file_retention.retention_days','ai-documents.providers.openai.name','ai-documents.providers.openai.supported','ai-documents.providers.openai.models.gpt-4o-mini.vision',
'ai-documents.providers.openai.models.gpt-4o-mini.supported','ai-documents.providers.openai.models.gpt-4o.vision','ai-documents.providers.openai.models.gpt-4o.supported','ai-documents.providers.gemini.name','ai-documents.providers.gemini.supported',
'ai-documents.providers.gemini.models.gemini-2.5-flash.vision','ai-documents.providers.gemini.models.gemini-2.5-flash.supported','ai-documents.providers.gemini.models.gemini-2.5-pro.vision','ai-documents.providers.gemini.models.gemini-2.5-pro.supported','ai-documents.ocr.tesseract_enabled',
'ai-documents.ocr.tesseract_mode','ai-documents.ocr.tesseract_binary.path','ai-documents.ocr.tesseract_http.host','ai-documents.ocr.tesseract_http.port','ai-documents.ocr.tesseract_http.timeout',
'ai-documents.ocr.tesseract_http.endpoint','app.name','app.env','app.debug','app.url',
...
'app.available_languages.fr','app.available_languages.hu','app.available_languages.pl','app.available_locales.en-GB','app.available_locales.en-US',
'app.available_locales.fr-FR','app.available_locales.hu-HU','app.available_locales.pl-PL','auth.defaults.guard','auth.defaults.passwords',
...
'auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','database.default',
...
'database.connections.pgsql.prefix_indexes','database.connections.pgsql.schema','database.connections.pgsql.sslmode','database.connections.pgsql.search_path','database.connections.sqlsrv.driver',
...
'debugbar.theme','debugbar.debug_backtrace_limit','demo.ai_provider','demo.ai_model','demo.ai_api_key',
'demo.google_drive_folder_id','demo.google_drive_json_key_file','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root',
...
'mailbox.only_store_matching_emails','mailbox.basic_auth.username','mailbox.basic_auth.password','mailbox.services.mailgun.key','recaptcha.api_site_key',
...
'sentry.tracing.redis_origin','sentry.tracing.missing_routes','sentry.tracing.continue_after_response','sentry.tracing.default_integrations','services.postmark.token',
...
'services.slack.notifications.channel','services.mailgun.domain','services.mailgun.secret','services.mailgun.endpoint','telescope.enabled',
...
'telescope.ignore_paths','telescope.ignore_commands','telescope.watchers.Laravel\\Telescope\\Watchers\\BatchWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\CacheWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ClientRequestWatcher',
'telescope.watchers.Laravel\\Telescope\\Watchers\\CommandWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\CommandWatcher.ignore','telescope.watchers.Laravel\\Telescope\\Watchers\\DumpWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\EventWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\EventWatcher.ignore',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.size_limit','telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','translation_sheet.googleApplicationName',
'translation_sheet.serviceAccountEmail','translation_sheet.serviceAccountCredentialsFile','translation_sheet.spreadsheetId','translation_sheet.locales','translation_sheet.exclude',
'translation_sheet.primary_sheet.name','translation_sheet.extra_sheets','translation_sheet.skip_empty_for_php','trustedproxy.proxies','yaffa.version',
'yaffa.admin_email','yaffa.alpha_vantage_key','yaffa.registered_user_limit','yaffa.incoming_receipts_email','yaffa.email_verification_required',
'yaffa.runs_scheduler','yaffa.sandbox_mode','yaffa.gtm_container_id','yaffa.cookieyes_id','yaffa.account_date_presets.0.label',
...
'scramble.flatten_deep_query_parameters','scramble.middleware','scramble.extensions','currency-exchange-rates.cache_prefix','currency-exchange-rates.default_provider',
'currency-exchange-rates.frankfurter.cache_ttl','boost.enabled','boost.browser_logs_watcher','boost.executable_paths.php','boost.executable_paths.composer',
'boost.executable_paths.npm','boost.executable_paths.vendor_bin','boost.executable_paths.current_directory','mcp.redirect_domains','prism.prism_server.middleware',
...
'prism.providers.perplexity.api_key','prism.providers.perplexity.url','prism.providers.z.url','prism.providers.z.api_key','roach.request_queue',
...
'ide-helper.additional_relation_return_types','ide-helper.enforce_nullable_relationships','ide-helper.soft_deletes_force_nullable','ide-helper.post_migrate','breadcrumbs.view',
...
'boost.browser-logs','dusk.login','dusk.logout','dusk.user','sanctum.csrf-cookie','telescope','api.v1.currency-rates.index',
'api.v1.currency-rates.store','api.v1.currency-rates.update','api.v1.currency-rates.destroy','api.v1.currency-rates.retrieve-missing','api.v1.investment-prices.index',
'api.v1.investment-prices.store','api.v1.investment-prices.update','api.v1.investment-prices.destroy','api.v1.investment-prices.retrieve-missing','api.v1.investment-prices.check',
'api.v1.ai.config.show','api.v1.ai.config.store','api.v1.ai.config.update','api.v1.ai.config.destroy','api.v1.ai.config.test',
'api.v1.ai.settings.show','api.v1.ai.settings.update','api.v1.google-drive.config.show','api.v1.google-drive.config.store','api.v1.google-drive.config.update',
'api.v1.google-drive.config.destroy','api.v1.google-drive.config.test','api.v1.google-drive.config.sync','api.v1.documents.store','api.v1.documents.index',
'api.v1.documents.show','api.v1.documents.update','api.v1.documents.reprocess','api.v1.documents.checkDuplicates','api.v1.documents.destroy',
'api.v1.accounts.index','api.v1.accounts.investment','api.v1.accounts.balance','api.v1.accounts.balance.show','api.v1.accounts.show',
'api.v1.accounts.monthly-summary','api.v1.account-entities.patch-active','api.v1.account-entities.destroy','api.v1.account-groups.destroy','api.v1.categories.index',
'api.v1.categories.store','api.v1.categories.show','api.v1.categories.patch-active','api.v1.categories.destroy','api.v1.investments.index',
'api.v1.investments.timeline','api.v1.investments.show','api.v1.investments.patch-active','api.v1.investments.price-history','api.v1.investments.destroy',
'api.v1.investment-groups.destroy','api.v1.payees.index','api.v1.payees.store','api.v1.payees.similar','api.v1.payees.category-suggestions.default',
'api.v1.payees.show','api.v1.payees.update','api.v1.payees.category-suggestions.accept','api.v1.payees.category-suggestions.dismiss','api.v1.payees.category-stats',
'api.v1.tags.index','api.v1.tags.show','api.v1.tags.patch-active','api.v1.transactions.index','api.v1.transactions.scheduled-items',
'api.v1.transactions.store-standard','api.v1.transactions.store-investment','api.v1.transactions.update-standard','api.v1.transactions.update-investment','api.v1.transactions.skip',
'api.v1.transactions.show','api.v1.transactions.reconcile','api.v1.transactions.destroy','api.v1.reports.budget-chart','api.v1.reports.cashflow',
'api.v1.reports.waterfall','api.v1.onboarding.show','api.v1.onboarding.dismiss','api.v1.onboarding.complete-tour','api.v1.users.me.settings',
'api.v1.users.me.password','api.v1.users.me.preferences.get','api.v1.users.me.preferences.set','home',
'terms','account-groups.index','account-groups.create','account-groups.store','account-groups.edit',
'account-groups.update','account-groups.destroy','account-entity.index','account-entity.create','account-entity.store',
'account-entity.show','account-entity.edit','account-entity.update','account.history','payees.merge.form',
'payees.merge.submit','categories.index','categories.create','categories.store','categories.edit',
'categories.update','categories.destroy','categories.merge.form','categories.merge.submit','currencies.index',
'currencies.create','currencies.store','currencies.edit','currencies.update','currencies.destroy',
'currencies.setDefault','currency-rate.index','investment-groups.index','investment-groups.create','investment-groups.store',
'investment-groups.edit','investment-groups.update','investment-groups.destroy','investments.index','investments.create',
'investments.store','investments.show','investments.edit','investments.update','investments.destroy',
'investment-price.list','tags.index','tags.create','tags.store','tags.edit',
'tags.update','tags.destroy','transaction.create','transaction.open','transactions.skipScheduleInstance',
'transactions.createFromDraft','transactions.destroy','reports.cashflow','reports.budgetchart','report.schedules',
'reports.transactions','reports.investment_timeline','search','import.csv','ai-documents.index',
'ai-documents.show','ai-documents.files.show','user.settings','user.ai-settings','login','logout','register','password.request',
...
'account-groups.form','account-groups.index','accounts.form','accounts.history','accounts.index',
'accounts.show','ai-documents.index','ai-documents.show','auth.components.email','auth.components.password',
...
'components.nav-link','components.tablefilter-sidebar-switch','currencies.form','currencies.index','currency-rates.index',
'emails.ai-document-processed','emails.ai-document-processing-failed','emails.google-drive-import-failed','emails.google-drive-import-success','emails.testmail',
'import.csv','investment-groups.form','investment-groups.index','investment-prices.list','investments.form',
'investments.index','investments.show','pages.dashboard','pages.sandbox-terms','payees.form',
'payees.index','payees.merge','reports.budgetchart','reports.cashflow','reports.investment-timeline',
'reports.schedule','reports.transactions','search.search','tags.form','tags.index',
...
'user.ai-settings','user.settings','breadcrumbs::bootstrap4','breadcrumbs::bootstrap5','breadcrumbs::bulma',
'breadcrumbs::foundation6','breadcrumbs::materialize','breadcrumbs::tailwind','breadcrumbs::uikit','duskapiconf::data',
...
'default_assets.investment_groups.other','default_assets.investment_groups.stocks','default_assets.tags.todo','mail.common.na','mail.common.greeting',
'mail.common.thanks','mail.labels.source_type','mail.labels.submitted','mail.labels.processed','mail.labels.document_id',
'mail.labels.type','mail.labels.amount','mail.labels.date','mail.labels.reason','mail.source_types.manual_upload',
'mail.source_types.received_email','mail.source_types.google_drive','mail.transaction_types.withdrawal','mail.transaction_types.deposit','mail.transaction_types.transfer',
'mail.transaction_types.buy','mail.transaction_types.sell','mail.transaction_types.dividend','mail.transaction_types.interest','mail.transaction_types.add_shares',
'mail.transaction_types.remove_shares','mail.ai_document_processed.subject','mail.ai_document_processed.intro','mail.ai_document_processed.what_happened','mail.ai_document_processed.extracted_summary',
'mail.ai_document_processed.next_action_title','mail.ai_document_processed.next_action_text','mail.ai_document_processed.button_review_document','mail.ai_document_processed.button_open_documents','mail.ai_document_processing_failed.subject',
'mail.ai_document_processing_failed.intro','mail.ai_document_processing_failed.document_details','mail.ai_document_processing_failed.next_action_title','mail.ai_document_processing_failed.next_action_text','mail.ai_document_processing_failed.settings_hint',
'mail.ai_document_processing_failed.fallback_reason','mail.ai_document_processing_failed.button_review_reprocess','mail.ai_document_processing_failed.button_open_settings','mail.google_drive_import_success.subject','mail.google_drive_import_success.intro',
'mail.google_drive_import_success.folder','mail.google_drive_import_success.imported','mail.google_drive_import_success.skipped_existing','mail.google_drive_import_success.skipped_unsupported','mail.google_drive_import_success.skipped_too_large',
'mail.google_drive_import_success.failed_downloads','mail.google_drive_import_success.button_open_documents','mail.google_drive_import_failed.subject','mail.google_drive_import_failed.intro','mail.google_drive_import_failed.folder',
'mail.google_drive_import_failed.error','mail.google_drive_import_failed.error_count','mail.google_drive_import_failed.button_open_settings','validation.attributes.config.opening_balance','validation.attributes.name',
...
'INCOMING_RECEIPTS_EMAIL','AI_DOCUMENT_ALLOWED_TYPES','TESSERACT_ENABLED','TESSERACT_MODE','TESSERACT_PATH',
'TESSERACT_LANGUAGE','TESSERACT_HTTP_HOST','TESSERACT_HTTP_PORT','TESSERACT_HTTP_TIMEOUT','TS_SERVICE_ACCOUNT_EMAIL',
'TS_SERVICE_ACCOUNT_CREDENTIALS_FILE','TS_SPREADSHEET_ID','TS_LOCALES','WWWGROUP','WWWUSER',
'SENTRY_LARAVEL_DSN','SENTRY_TRACES_SAMPLE_RATE','RECAPTCHA_SITE_KEY','RECAPTCHA_SECRET_KEY','GTM_CONTAINER_ID',
'COOKIEYES_ID','SANDBOX_MODE','DEMO_AI_PROVIDER','DEMO_AI_MODEL','DEMO_AI_API_KEY',
'DEMO_GOOGLE_DRIVE_FOLDER_ID','DEMO_GOOGLE_DRIVE_JSON_KEY_FILE','SERVER_NAME','SSL_DOMAIN','TRUSTED_PROXIES',);
