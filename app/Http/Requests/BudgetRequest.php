...
class BudgetRequest extends FormRequest
{
    ...
    public function attributes(): array
    {
        return [
            ...
            'days_before_month_end' => __('schedule days before month end'),
            'last_business_day_of_month' => __('schedule last business day of month'),
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'by_day' => $this->byDayRule('frequency', 'days_before_month_end', 'last_business_day_of_month'),
            'by_month' => $this->byMonthRule('frequency', 'by_day', 'days_before_month_end', 'last_business_day_of_month'),
            'days_before_month_end' => $this->daysBeforeMonthEndRule('frequency', 'by_day', 'last_business_day_of_month'),
            'last_business_day_of_month' => $this->lastBusinessDayOfMonthRule('frequency', 'by_day', 'days_before_month_end'),
            'count' => [
                'nullable',
                'integer',
                'gte:1',
