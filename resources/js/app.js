...
routeMap.set('gocardless.create', 'gocardless/create');
routeMap.set('gocardless.index', 'gocardless/index');
routeMap.set('gocardless.linkAccounts', 'gocardless/link-accounts');
