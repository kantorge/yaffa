            ...
            createChart() {
                ...
                if (!this.categoryAxisVisible) {
                    ...
                    categoryAxis.events.on('sizechanged', function (ev) {
                        ...
                        if (
                            cellWidth < axis.renderer.labels.template.maxWidth
                        ) {
                            axis.renderer.labels.template.rotation = -45;
                            axis.renderer.labels.template.horizontalCenter =
                                'right';
                            axis.renderer.labels.template.verticalCenter =
                                'middle';
                        } else {
                ...
                if (this.clickable) {
                    columnTemplate.cursorOverStyle =
                ...
                const messageLabel = noDataMessagecontainer.createChild(
                    am4core.Label,
                );
