...
const deleteButtonConditions = [
  {
    ...
    negate: false,
    errorMessage: __(
      'This investment group cannot be deleted because it is still in use.',
    ),
  },
];
      ...
      render: function (data, _type, row) {
        return (
          genericDataTablesActionButton(
            data,
            'edit',
            'investment-groups.edit',
          ) +
          renderDeleteAssetButton(
            row,
            deleteButtonConditions,
            __('This investment group cannot be deleted.'),
          )
        );
      },
      className: 'dt-nowrap',
...
initializeDeleteAssetButtonListener(
  ...
  __('Investment group deleted'),
  function (id, tr) {
    window.investmentGroups = window.investmentGroups.filter(
      (investmentGroup) => investmentGroup.id !== id,
    );
...
window.onboardingTourSteps = [
  {
    ...
    popover: {
      ...
      description: __(
        'Investment groups serve as an organizational tool to streamline your investment overview.',
      ),
    },
  },
  {
    ...
    popover: {
      ...
      description: __(
        'You can create new investment groups to organize your investments.',
      ),
    },
  },
];
