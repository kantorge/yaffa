                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-9 btn-group mb-3 mb-xl-0">
                                    ...
                                    >
                                        <span
                                            class="fa fa-circle-minus text-danger"
                                        ></span
                                        ><br />
                                        {{ __('Withdraw') }}
                                    </button>
                                    <button
                                        class="btn"
                                        :class="
                                            transactionTypeBaseClass('deposit')
                                        "
                                        :disabled="!isBaseSettingsEditsAllowed"
                                    ...
                                    >
                                        <span
                                            class="fa fa-circle-plus text-success"
                                        ></span
                                        ><br />
                                        {{ __('Deposit') }}
                                    </button>
                                    <button
                                        class="btn"
                                        :class="
                                            transactionTypeBaseClass('transfer')
                                        "
                                        :disabled="!isBaseSettingsEditsAllowed"
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                >
                                    ...
                                    <div
                                        id="account_from_container"
                                        class="input-group"
                                    >
                                        <select
                                            id="account_from"
                                            v-model="
                                                form.config.account_from_id
                                            "
                                            class="form-select"
                                        ></select>
                                        <button
                                ...
                                <div
                                    class="col-12"
                                    :class="
                                        form.errors.has('config.account_to_id')
                                            ? 'has-error'
                                            : ''
                                    "
                                >
                            ...
                            <div class="row mb-3">
                                <div
                                    class="col-4"
                                    :class="
                                        form.errors.has('config.amount_from')
                                            ? 'has-error'
                                            : ''
                                    "
                                >
                                    <label
                                        for="transaction_amount_from"
                                        class="form-label"
                                    >
                                ...
                                <div
                                    ...
                                    class="col-4"
                                    :class="
                                        form.errors.has('config.amount_to')
                                            ? 'has-error'
                                            : ''
                                    "
                                >
                                    <label
                                        for="transaction_amount_to"
                                        class="form-label"
                                    >
                                        {{ __('Amount to') }}
                                        <span
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            ammountFromFieldLabel() {
                return this.exchangeRatePresent
                    ? __('Amount from')
                    : __('Amount');
            },
            ...
            allocatedAmount() {
                return this.form.items
                    .reduce(
                        (amount, item) =>
                            amount.plus(new Decimal(item.amount || 0)),
                        new Decimal(0),
                    )
                    .toNumber();
            },
            ...
            remainingAmountToPayeeDefault() {
                if (
                    this.payeeCategory.id &&
                    !isNaN(this.form.config.amount_from)
                ) {
            ...
            exchangeRatePresent() {
                return (
                    ...
                    this.from.account_currency.id !==
                        this.to.account_currency.id
                );
            },
        ...
        methods: {
            ...
            initializeTransaction() {
                ...
                if (
                    ...
                    // Copy configuration
                    this.form.config.amount_from =
                        this.transaction.config.amount_from;
                    this.form.config.amount_to =
                        this.transaction.config.amount_to;
            ...
            onChangeTransactionType(newState, forceUpdate) {
                ...
                if (
                    oldTypeFrom !== this.getAccountType('from') ||
                    forceUpdate
                ) {
                ...
                if (!this.callbackOptions[selectedCallbackIndex].enabled) {
                    this.callback = this.callbackOptions.find(
            ...
            getAccountApiUrl(type) {
                ...
                return this.getAccountType(type) === 'account'
                    ? accountUrl
                    : payeeUrl;
            },
                ...
                return {
                    ...
                    ajax: {
                        ...
                        processResults: (data) => {
                            ...
                            let otherAccountId =
                                this.form.config[
                                    'account_' + otherType + '_id'
                                ];
                            if (otherAccountId) {
                                data = data.filter(
                                    (item) => item.id != otherAccountId,
                                );
                            }
            ...
            onSubmit() {
                ...
                this.form
                    .post(
                        this.route('api.v1.transactions.store-standard'),
                        this.form,
                    )
                    .then((response) => {
                        this.$emit(
            ...
            transactionTypeBaseClass(transactionType) {
                ...
                if (this.isBaseSettingsEditsAllowed) {
                    return (
                        'btn-outline-primary' +
                        (this.form.transaction_type === transactionType
                            ? ' active'
                            : '')
                    );
                }
