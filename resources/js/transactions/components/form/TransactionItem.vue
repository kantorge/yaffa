    ...
    >
        ...
        >
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <span
                    v-else-if="
                        recommended_category_id && !isRecommendationAccepted
                    "
                ...
                <span
                    v-else-if="
                        description !== null && confidence_score === null
                    "
                    class="badge"
                    :class="'bg-danger'"
        ...
        <div class="row">
            ...
            <div
                class="col-12 col-sm-1 justify-content-end d-flex align-items-start"
            >
                <button
                    type="button"
