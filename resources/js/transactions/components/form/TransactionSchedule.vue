        ...
        <div :class="bare ? null : 'card-body'">
            <div class="schedule-groups">
                <div class="p-3 rounded border">
                    ...
                    <div
                        class="mb-3"
                        :class="hasError('frequency') ? 'has-error' : ''"
                    >
          ...
          -->
                    ...
                    >
                        <div class="form-check mb-1">
                            <input
                                :id="
                                    'schedule_pattern_day_of_month_' +
                                    $.vnode.key
                                "
                                v-model="patternMode"
                                ...
                                value="dayOfMonth"
                                :disabled="
                                    !allowCustomizationData ||
                                    !showPatternPicker
                                "
                                :title="
                                    !showPatternPicker
                                        ? __(
                                              'Available for monthly or yearly frequency',
                                          )
                                        : ''
                                "
                            />
                        ...
                        <div class="d-flex flex-wrap align-items-center gap-2">
                            ...
                            >
                                <select
                                    :id="
                                        'schedule_by_day_ordinal_' + $.vnode.key
                                    "
                                ...
                                <select
                                    :id="
                                        'schedule_by_day_weekday_' + $.vnode.key
                                    "
                            ...
                            <template
                                v-if="
                                    patternMode === 'weekday' && showMonthPicker
                                "
                            >
                        ...
                        <div class="form-check mb-1 mt-1">
                            <input
                                :id="
                                    'schedule_pattern_days_before_month_end_' +
                                    $.vnode.key
                                "
                                v-model="patternMode"
                                class="form-check-input"
                            ...
                            >
                                {{
                                    __(
                                        'A number of days before the end of the month',
                                    )
                                }}
                            </label>
                        </div>
                        <div
                            v-if="
                                patternMode === 'daysBeforeMonthEnd' &&
                                showPatternPicker
                            "
                        ...
                        >
                            <input
                                :id="
                                    'schedule_days_before_month_end_' +
                                    $.vnode.key
                                "
                            ...
                            <template v-if="showMonthPicker">
                                ...
                                <select
                                    :id="
                                        'schedule_days_before_month_end_by_month_' +
                                        $.vnode.key
                                    "
                                    v-model.number="schedule.by_month"
                                    class="form-select schedule-month-select"
                        ...
                        <div class="form-check mb-0">
                            <input
                                :id="
                                    'schedule_pattern_last_business_day_' +
                                    $.vnode.key
                                "
                                v-model="patternMode"
                                class="form-check-input"
                        ...
                        >
                            ...
                            <select
                                :id="
                                    'schedule_last_business_day_by_month_' +
                                    $.vnode.key
                                "
                                v-model.number="schedule.by_month"
                                class="form-select schedule-month-select"
                ...
                <div class="p-3 rounded border">
                    ...
                    <div class="field-grid field-grid-2col">
                        <div
                            :class="{
                                'has-error':
                                    hasError('start_date') || tooManyPeriods,
                            }"
                        >
                            <label
                                :for="'schedule_start_' + $.vnode.key"
                                class="form-label"
                            >
                                {{ __('Start date') }}
                            </label>
                        ...
                        <div
                            ...
                            :class="{
                                'has-error':
                                    hasError('next_date') || nextDateMismatch,
                            }"
                        >
                            <label
                                :for="'schedule_next_' + $.vnode.key"
                                class="form-label"
                            >
                                {{ __('Next date') }}
                                <span
                            ...
                            <div
                                v-if="nextDateMismatch"
                                class="form-text text-danger"
                            >
                                {{
                                    __(
                                        'This date does not match the configured pattern',
                                    )
                                }}
                            </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            byDayOrdinal: {
                get() {
                    return this.schedule.by_day
                        ? this.schedule.by_day.slice(0, -2)
                        : '1';
                },
                set(value) {
            ...
            scheduleRule() {
                ...
                if (this.schedule.days_before_month_end != null) {
                    ruleOptions.bymonthday = -(
                        this.schedule.days_before_month_end + 1
                    );
                    ...
                    ruleOptions.byweekday = byDayToRRuleWeekday(
                        this.schedule.by_day,
                    );
                }
            ...
            nextOccurrence() {
                ...
                try {
                    return current
                        ...
                        : rule.after(
                              toRRuleDate(this.schedule.start_date),
                              true,
                          );
                } catch {
                    return null;
