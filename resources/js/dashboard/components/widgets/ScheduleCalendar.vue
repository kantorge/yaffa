            ...
            getTransactionById(id) {
                ...
                return (
                    this.transactions.find(
                        (attribute) =>
                            Number(attribute.customData?.id) === transactionId,
                    )?.customData || null
                );
            },
    ...
    `;
            ...
            showPopover(triggerElement, transaction) {
                ...
                if (shouldRecreatePopover) {
                    ...
                    this.activePopover = new window.bootstrap.Popover(
                        triggerElement,
                        {
                            container: 'body',
            ...
            async skipInstance(transactionId, buttonElement = null) {
                ...
                try {
                    ...
                    toastHelpers.showSuccessToast(
                        this.__('Schedule instance skipped.'),
                    );
            ...
            async restoreVisiblePage() {
                ...
                try {
                    api.gotoDate(
                        new Date(
                            this.visiblePage.year,
                            this.visiblePage.month - 1,
                            1,
                        ),
                    );
                } catch (_error) {
