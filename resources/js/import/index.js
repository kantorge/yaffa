...
app.component('TransactionQuickviewModal', QuickViewTransactionModal);
...
window.onboardingTourSteps = [
    {
        ...
        popover: {
            ...
            description: __(
                "Select QIF or CSV depending on your bank's export format. QIF is the traditional format; CSV gives you more flexibility with a custom import profile.",
            ),
        },
    },
    {
        ...
        popover: {
            ...
            description: __(
                'Select the file exported from your bank. Accepted formats change based on the selected source type.',
            ),
        },
    },
    {
        ...
        popover: {
            ...
            description: __(
                "Profiles tell the parser how to interpret your file's fields. System profiles are provided out of the box; you can also create your own custom profiles below.",
            ),
        },
    },
    {
        ...
        popover: {
            ...
            description: __(
                'After uploading, each row from your file becomes a draft. Review the date, amount, and payee, then finalize or ignore each one individually.',
            ),
        },
    },
    {
        ...
        popover: {
            ...
            description: __(
                'Use these checkboxes to show or hide drafts, ignored entries, and finalized transactions to keep the list manageable.',
            ),
        },
    },
    {
        ...
        popover: {
            ...
            description: __(
                'Create, edit, and delete your custom import profiles here. For CSV files a step-by-step wizard helps you configure column mappings; for QIF you can remap field markers.',
            ),
        },
    },
];
...
onboardingApp.component('OnboardingCard', OnboardingCard);
