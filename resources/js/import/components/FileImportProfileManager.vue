<template>
    <div id="import-profile-manager" class="card mb-3">
        ...
        <div :id="collapseId" class="collapse card-body show">
            ...
            >
                ...
                <div class="d-flex gap-2">
                    <button
                        ...
                        :disabled="
                            saving || (fileType === 'csv' && !!mappingJsonError)
                        "
                        @click="saveProfile"
                    >
            ...
            <div
                v-else-if="
                    userProfiles.length === 0 && !editingProfile && !showWizard
                "
            ...
            >
                {{
                    fileType === 'qif'
                        ...
                        : __(
                              'No custom profiles yet. Use the wizard to create one.',
                          )
                }}
            </div>
                ...
                <tbody>
                    ...
                    >
                        ...
                        <template v-else>
                            ...
                            <td class="font-monospace">
                                {{
                                    profile.options_json?.field_map?.payee ||
                                    'P'
                                }}
                            </td>
                            <td class="text-muted">
                                {{
                                    profile.options_json?.amount_sign ||
                                    'normal'
                                }}
                            </td>
                        </template>
                        <td class="text-end text-nowrap">
                            ...
                            <template
                                v-if="profile.account_entities?.length > 0"
                            >
                                <span
        ...
        methods: {
            ...
            async saveProfile() {
                ...
                if (this.fileType === 'qif') {
                    ...
                    let mappingJson;
                    try {
                        mappingJson = JSON.parse(
                            this.editingProfile.mapping_json_text,
                        );
                    } catch (_e) {
                        this.mappingJsonError = __(
                            'Invalid JSON. Please check the format.',
                    ...
                    payload = {
                        ...
                        decimal_separator:
                            this.editingProfile.decimal_separator || null,
                        thousand_separator:
                            this.editingProfile.thousand_separator || null,
                        sign_handling:
                            this.editingProfile.sign_handling || null,
            ...
            async deleteProfile(profile) {
                ...
                try {
                    await axios.delete(
                        `/api/v1/imports/file-profiles/${profile.id}`,
                    );
