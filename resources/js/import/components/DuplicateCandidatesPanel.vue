    ...
    <div v-if="candidates && candidates.length">
        ...
        <div class="duplicate-list d-flex flex-column gap-2">
            ...
            >
                ...
                <div
                    class="d-flex justify-content-between align-items-start mb-1 pe-4"
                >
                    <span
                        class="badge duplicate-confidence-badge"
                        :class="
                            confidenceBadgeClass(candidate.confidence_score)
                        "
                    >
                ...
                <!-- Comment (if present) -->
                <div
                    v-if="candidate.summary.comment"
                    class="small text-break mb-1"
                >
...
<script>
    ...
    export default {
        ...
        computed: {
            hasDraftAmount() {
                return (
                    this.draftAmount !== null && this.draftAmount !== undefined
                );
            },
        },
        methods: {
