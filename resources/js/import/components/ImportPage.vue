        ...
        methods: {
            async fetchAccounts() {
                ...
                try {
                    ...
                    this.accounts = Array.isArray(response.data)
                        ? response.data
                        : [];
                } catch (_error) {
                    this.uploadError = __(
            ...
            autoSelectProfile(accountId) {
                ...
                const preferredId =
                    account?.preferred_file_import_profile_id ?? null;
                ...
                if (this.sourceType === 'csv') {
                    ...
                    this.selectedQifProfileId = inQifProfiles
                        ? preferredId
                        : null;
                }
            },
            ...
            async onSubmit({ file }) {
                ...
                if (!this.selectedAccountId) {
                    this.uploadError = __(
                        'Please select a target account first.',
                    );
                    return;
                }
            ...
            onFinalizeDraft(draftIndex) {
                ...
                const transaction = {
                    ...
                    config: {
                        ...
                        amount_from:
                            draft.config?.amount_from ?? draft.amount ?? null,
                        amount_to:
                            draft.config?.amount_to ?? draft.amount ?? null,
                    },
                };
