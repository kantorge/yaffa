        ...
        <div class="row mb-4">
            <div class="col-sm-6">
                <dl class="row mb-0">
                    ...
                    <dd
                        class="col-6"
                        :class="{ 'text-muted': !draftTypeLabel }"
                    >
                    ...
                    <template v-else-if="isTransfer">
                        ...
                        >
                            <template
                                v-if="matchedEntities.account_from?.matched"
                            >
                                <a
                        ...
                        >
                            <template
                                v-if="matchedEntities.account_to?.matched"
                            >
                                <a
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr
                                v-for="(
                                    item, index
                                ) in draftData.transaction_items"
                                :key="index"
                            >
                                <td>
                                    {{
