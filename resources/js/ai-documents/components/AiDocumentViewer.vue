                ...
                >
                    <dl class="row mb-0">
                        ...
                        <template v-if="isInvestment">
                            ...
                            >
                                <template
                                    v-if="matchedEntities.account?.matched"
                                >
                                    <a
                            ...
                            >
                                <template
                                    v-if="matchedEntities.investment?.matched"
                                >
                                    <a
                        ...
                        <template v-else>
                            <template v-if="isTransfer">
                                ...
                                >
                                    ...
                                    >
                                        <a
                                            ...
                                            "
                                            :href="
                                                matchedEntities.account_from.url
                                            "
                                            target="_blank"
                                            rel="noopener noreferrer"
                                        >
                                ...
                                <dd
                                    ...
                                    :class="{
                                        'text-muted text-italic':
                                            isUnidentified(rawData.account_to),
                                    }"
                                >
                                    <template
                                        v-if="
                                            matchedEntities.account_to?.matched
                                        "
                                    >
                                        <a
                                            v-if="
                                                matchedEntities.account_to?.url
                                            "
                                            :href="
                                                matchedEntities.account_to.url
                                            "
                            ...
                            <template v-else>
                                ...
                                <dd
                                    ...
                                    :class="{
                                        'text-muted text-italic':
                                            isUnidentified(rawData.account),
                                    }"
                                >
                                    <template
                                        v-if="matchedEntities.account?.matched"
                                ...
                                <dd
                                    ...
                                    :class="{
                                        'text-muted text-italic':
                                            isUnidentified(rawData.payee) &&
                                            !matchedEntities.payee?.matched,
                                    }"
                                >
                                    <template
                                        v-if="matchedEntities.payee?.matched"
                                    >
                                        <span>{{
                                            matchedEntities.payee.name
                                        }}</span>
                                        <span class="text-muted small ms-1">
                                            <i
                                                class="fa fa-check-circle text-success"
                ...
                <div class="card-body">
                    <div id="document-tab-content" class="tab-content">
                        ...
                        <div
                            ...
                            tabindex="0"
                        >
                            <ai-document-processing-history
...
<script setup>
    ...
    import TransactionFormModalInvestment from '@/transactions/components/form/ModalInvestment.vue';
    ...
    const isTransfer = computed(
        () => draftTransactionType.value === 'transfer',
    );
    ...
    const canFinalize = computed(
        () =>
            aiDocument.value.status === 'ready_for_review' &&
            hasDraftData.value,
    );
    ...
    const canReprocess = computed(() =>
        ['ready_for_review', 'processing_failed'].includes(
    ...
    const finalizeDocument = () => {
        ...
        if (!hasDraftData.value) {
            toastHelpers.showErrorToast(
                __('No draft data available to finalize.'),
            );
            return;
        }
