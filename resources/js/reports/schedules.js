    ...
    },
    {
      ...
      action: function (row) {
        ...
        toastHelpers.showLoaderToast(
          __('Skipping schedule instance for transaction #:transactionId', {
            transactionId: id,
          }),
        ...
        window.axios
          ...
          .then(function (response) {
            ...
            toastHelpers.showSuccessToast(
              __('Transaction instance skipped (#:transactionId)', {
                transactionId: id,
              }),
            );
          })
          .catch(function (error) {
            ...
            toastHelpers.showErrorToast(
              __('Error skipping transaction (#:transactionId): :error', {
                transactionId: id,
                error: error,
              }),
            );
        ...
        Swal.fire({
          ...
          window.axios
            ...
            .then(function () {
              ...
              // Emit a custom event to global scope about the result
              toastHelpers.showSuccessToast(__('Deleted (#:id)', { id: id }));
            })
            .catch(function (error) {
              // Emit a custom event to global scope about the result
              toastHelpers.showErrorToast(
