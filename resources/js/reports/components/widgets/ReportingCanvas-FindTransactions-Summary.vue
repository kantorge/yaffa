        ...
        <div v-else class="row">
            <div class="col-12">
                <p
                    v-html="
                        __(
                            'Your search returned <strong>:total</strong> transactions in total',
                ...
                <p>
                    {{
                        __('The earliest transaction is from :date', {
                            date: minDateFormatted,
                        })
                    }}
                    {{
                        __('The latest transaction is from :date', {
                ...
                <table class="table table-borderless table-striped">
                    ...
                    <tbody>
                        ...
                        >
                            <td v-if="summary.currency_id === 0" colspan="2">
                                {{ summary.currency_name }}
                            </td>
                            <td v-if="summary.currency_id !== 0"></td>
                            <td v-if="summary.currency_id !== 0">
                                {{ summary.currency_name }}
                            </td>
                            <td>{{ summary.count }}</td>
                            <td>
