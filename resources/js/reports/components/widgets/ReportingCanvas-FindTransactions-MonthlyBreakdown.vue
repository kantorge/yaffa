<template>
    <div class="reporting-monthly-breakdown">
        ...
        <div v-else class="table-responsive breakdown-table-wrapper">
            <table
                class="table table-sm table-bordered table-hover breakdown-table"
            >
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    >
                        ...
                        <tr v-for="row in section.rows" :key="row.name">
                            <td
                                class="sticky-col category-name"
                                :title="row.name"
                            >
                                <a
                            ...
                            >
                                <a
                                    ...
                                    class="cell-link"
                                    @click.prevent="
                                        emitDrillDown(month, row.categoryIds)
                                    "
                                >
                                    {{
                                        formatCell(
                    ...
                    <tr class="grand-row">
                        ...
                        <td
                            class="text-end fw-bold"
                            :class="
                                balanceSum >= 0 ? 'text-success' : 'text-danger'
                            "
                        >
                        ...
                        <td
                            class="text-end fw-bold"
                            :class="
                                balanceAvg >= 0 ? 'text-success' : 'text-danger'
                            "
                        >
            ...
            months() {
                ...
                if (this.cachedCategoryData) {
                    ...
                    Object.values(this.cachedCategoryData).forEach((entry) => {
                        Object.keys(entry.values).forEach((month) =>
                            monthSet.add(month),
                        );
                    });
        ...
        methods: {
            ...
            emitDrillDown(month, categoryIds) {
                ...
                this.$emit('drill-down', {
                    dateFrom,
                    dateTo,
                    categories: [...new Set(categoryIds)].map((id) =>
                        String(id),
                    ),
                });
            },
