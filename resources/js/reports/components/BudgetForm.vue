    ...
    export default {
        ...
        methods: {
            ...
            initializeAccountSelect() {
                this.accountSelect = $(this.$el).find(
                    `#${this.accountSelectId}`,
                );
            ...
            updateAccountCurrency(accountId) {
                ...
                fetch(
                    route('api.v1.accounts.show', { accountEntity: accountId }),
                )
                    .then((response) => {
                        if (!response.ok) {
                    ...
                    .then((data) => {
                        this.accountCurrencyCode =
                            data?.config?.currency?.iso_code ?? null;
                        this.accountCurrencyPending = false;
                    })
                    .catch(() => {
                        this.accountCurrencyCode = null;
            ...
            loadBudgetData(budgetId) {
                ...
                fetch(route('api.v1.budgets.show', { budget: budgetId }))
                    ...
                    .then((data) => {
                        ...
                        const precision =
                            currency?.generic_decimal_precision ?? 0;
                        this.form.amount =
                        ...
                        this.form.days_before_month_end =
                            data.days_before_month_end;
                        ...
                        if (this.action === 'replace') {
                            ...
                            originalEndDate.setDate(
                                originalEndDate.getDate() - 1,
                            );
