                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        >
                            <span>
                                {{
                                    __(
                                        'Only count matching items in breakdowns',
                                    )
                                }}
                                <i
                    ...
                    <div class="card left-control-panel-toggle-card">
                        ...
                        >
                            <button
                                ...
                                :aria-expanded="
                                    leftControlPanelToggleState.ariaExpanded
                                "
    ...
    export default {
        ...
        computed: {
            leftControlPanelToggleState() {
                return getLeftControlPanelToggleState(
                    this.leftControlPanelCollapsed,
                );
            },
        ...
        mounted() {
            ...
            this._onTabShown = (event) => {
                ...
                const targetId =
                    event.target.getAttribute('data-coreui-target');
        ...
        methods: {
            ...
            onMonthlyBreakdownDrillDown(event) {
                ...
                this.drillDownFilter = {
                    ...
                    categories: [
                        ...new Set(
                            (event.categories || []).map((id) => String(id)),
                        ),
                    ],
                };
            ...
            rebuildUrl(tab = null, returnTo = null) {
                ...
                if (this.selectedPreset) {
                    params.push(
                        'date_preset=' +
                            encodeURIComponent(this.selectedPreset),
                    );
                } else {
                    if (this.dateFrom) {
                ...
                // Payees
                const payees = this.selectedPayees.map(
                    (item) => 'payees[]=' + item,
                );
                params.push(...payees);
            ...
            getTransactions(options = null) {
                const keepDrillDown = !!(
                    options && options.keepDrillDown === true
                );
                this.busy = true;
                if (!keepDrillDown) {
                    this.drillDownFilter = null;
                ...
                window.axios
                    ...
                    .then((response) => {
                        ...
                        this.transactions =
                            response.data.data.map(processTransaction);
                    })
                    .catch((error) => {
