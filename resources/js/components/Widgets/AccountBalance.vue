<template>
    <div class="card mb-4" id="widgetAccountBalance">
        ...
        <ul class="list-group list-group-flush" v-if="state === 'data-not-available'">
        ...
        <ul class="list-group list-group-flush" id="accordionAccountBalance" v-if="state === 'data-available'">
            <li
...
export default {
    ...
    methods: {
        ...
        /**
         * This function refers to the generic helper function toFormattedCurrency, but with a twist:
         * it is fixed to 0 decimals, as the summary is not expected to have decimals.
         *
         * @param input
         * @param locale
        ...
        toFormattedCurrency(input, locale, currencySettings) {
            return helpers.toFormattedCurrency(
                input,
                locale,
                Object.assign(currencySettings, {max_digits: 0})
            );
        },
