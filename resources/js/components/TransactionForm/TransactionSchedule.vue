    ...
    <div class="card-body">
      <div class="row">
        <div
          ...
          :class="
            form.errors.has('schedule_config.frequency') ? 'has-error' : ''
          "
        >
          <label
            :for="'schedule_frequency_' + this.$.vnode.key"
            class="form-label"
          >
            {{ __('Frequency') }}
          </label>
        ...
        <div
          class="col-lg-1 col-6 mb-2"
          :class="
            form.errors.has('schedule_config.interval') ? 'has-error' : ''
          "
        >
          <label
            :for="'schedule_interval_' + this.$.vnode.key"
            class="form-label"
          >
            {{ __('Interval') }}
          </label>
        ...
        <div
          ...
          :class="{
            'has-error': form.errors.has('schedule_config.start_date'),
          }"
        >
        ...
        <div
          class="col-lg-2 col-6 mb-2"
          :class="{
            'has-error': form.errors.has('schedule_config.automatic_recording'),
          }"
          v-if="isSchedule"
        >
