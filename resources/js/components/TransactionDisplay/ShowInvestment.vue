                    ...
                    <div class="card-body">
                        <dl class="row">
                            ...
                            <dd class="col-6" dusk="label-account-name">
                                <a
                                        :href="route('account-entity.show', {account_entity: transaction.config.account.id})"
                            ...
                            <dd class="col-6" dusk="label-investment-name">
                                <a
                                        :href="route('investment.show', {investment: transaction.config.investment.id})"
                            ...
                            <dd class="col-6" :class="(transaction.comment ? '' : 'text-muted text-italic')">
                    ...
                    <div class="card-body">
                        <dl class="row">
                            ...
                            <dd class="col-6" v-if="transaction.config.commission">
                                {{
                                    toFormattedCurrency(transaction.config.commission, locale, transaction.config.account.config.currency)
                                }}
                            </dd>
                            ...
                            <dd class="col-6" v-if="transaction.config.tax">
                                {{
                                    toFormattedCurrency(transaction.config.tax, locale, transaction.config.account.config.currency)
                                }}
                            </dd>
                            <dd class="col-6" v-else>
                                <span class="text-muted text-italic">{{ __('Not set') }}</span>
                            ...
                            <dd class="col-6" v-if="transaction.config.dividend" dusk="label-dividend">
                                {{
                                    toFormattedCurrency(transaction.config.dividend, locale, transaction.config.account.config.currency)
                                }}
                            </dd>
...
export default {
    ...
    computed: {
        total() {
            return (this.transaction.config.quantity || 0) * (this.transaction.config.price || 0)
