<template>
  <div class="card mb-3">
    ...
    <div class="card-footer text-end">
      <button class="btn btn-sm btn-outline-dark" @click="clearSelection">
        {{ __('Clear selection') }}
      </button>
      <button
...
<script>
  ...
  export default {
    ...
    mounted() {
      this.dateRangePicker = new DateRangePicker(this.$refs.dateRangePicker, {
      ...
      const dateFromInput =
        this.$refs.dateRangePicker.querySelector('[name="date_from"]');
      const dateToInput =
        this.$refs.dateRangePicker.querySelector('[name="date_to"]');
    ...
    methods: {
      ...
      onDateChange() {
        ...
        this.$emit('dateChange', {
          ...
          dateTo: this.dateTo,
          preset: this.isPresetChange
            ? document.getElementById('dateRangePickerPresets')?.value
            : 'none',
        });
      },
