                    ...
                    >
                        ...
                        <div v-else>
                            ...
                            <div class="row g-4">
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        v-model="
                                            forms[provider.key].credentials[
                                                field.key
                                            ]
                                        "
                                ...
                                <div
                                    v-if="
                                        provider.rateLimitPolicy?.overrideable
                                    "
                                    class="col-12 col-lg-6"
                                >
                                    <div class="row g-3">
                            ...
                            <div
                                ...
                                :class="
                                    actionMessages[provider.key].type ===
                                    'success'
                                        ? 'alert-success'
                                        : 'alert-danger'
                                "
        ...
        methods: {
            ...
            async loadProviders() {
                ...
                try {
                    ...
                    this.providers = Array.isArray(response.data)
                        ? response.data
                        : [];
                    ...
                    if (
                        ...
                        !this.providers.find(
                            (provider) =>
                                provider.key === this.activeProviderKey,
                        )
                    ) {
            ...
            formStateForProvider(provider, previousForm = null) {
                ...
                const rateLimitOverrides =
                    currentConfig.rate_limit_overrides || {};

                return {
                    credentials: this.credentialFields(provider).reduce(
                        (carry, field) => {
                            carry[field.key] =
                                previousForm?.credentials?.[field.key] || '';
                            return carry;
                        },
                        {},
                    ),
            ...
            payloadForProvider(provider) {
                ...
                if (provider.rateLimitPolicy?.overrideable) {
                    ...
                    if (form.rateLimitOverrides.perMinute !== '') {
                        overrides.perMinute = Number(
                            form.rateLimitOverrides.perMinute,
                        );
                    }

                    if (form.rateLimitOverrides.perDay !== '') {
                        overrides.perDay = Number(
                            form.rateLimitOverrides.perDay,
                        );
                    }
            ...
            async saveProvider(provider) {
                ...
                try {
                    await axios.patch(
                        this.route(
                            'api.v1.investment-provider-configs.update',
                            {
                ...
                try {
                    ...
                    this.actionMessages[provider.key] = {
                        ...
                        message:
                            ...
                            __('Provider configuration is valid.'),
                    };
                    toastHelpers.showSuccessToast(
                        response.data?.message ||
                            __('Provider configuration is valid.'),
            ...
            async removeProvider(provider) {
                if (
                    ...
                    this.isProviderBusy(provider.key)
                ) {
                    return;
                }
                ...
                try {
                    await axios.delete(
                        this.route(
                            'api.v1.investment-provider-configs.destroy',
                            {
                                providerKey: provider.key,
                            },
                        ),
                    ...
                    toastHelpers.showSuccessToast(
                        __('Provider configuration removed.'),
                    );
                    await this.loadProviders();
                } catch (error) {
                    console.error(error);
