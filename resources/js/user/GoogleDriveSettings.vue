            ...
            <div class="card-header d-flex justify-content-between">
                ...
                <div>
                    <span
                        ...
                        :title="
                            __(
                                'user.googleDriveSettings.aiProcessingDisabledWarning',
                            )
                        "
                ...
                <div v-if="hasConfig || showForm">
                    <div v-if="hasConfig" class="row mb-3">
                        <label class="col-form-label col-sm-3">
                            {{
                                __(
                                    'user.googleDriveSettings.fields.serviceAccountEmail.label',
                                )
                            }}
                        </label>
                        <div class="col-sm-9">
                            <p
                                ...
                                dusk="service-account-email"
                            >
                                {{
                                    serviceAccountEmail ||
                                    __(
                                        'user.googleDriveSettings.common.notAvailable',
                                    )
                                }}
                            </p>
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        >
                            {{
                                __(
                                    'user.googleDriveSettings.fields.jsonKeyFile.label',
                                )
                            }}
                        </label>
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <span
                                    ...
                                    :title="
                                        __(
                                            'user.googleDriveSettings.fields.jsonKeyFile.uploadInfo',
                                        )
                                    "
                                >
                    ...
                    <div class="row mb-3">
                        ...
                        >
                            {{
                                __(
                                    'user.googleDriveSettings.fields.serviceAccountJson.label',
                                )
                            }}
                        </label>
                        <div class="col-sm-9">
                    ...
                    <div class="row mb-3">
                        <label for="folder_id" class="col-form-label col-sm-3">
                            {{
                                __(
                                    'user.googleDriveSettings.fields.folderId.label',
                                )
                            }}
                        </label>
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input
                                    ...
                                    :placeholder="
                                        __(
                                            'user.googleDriveSettings.fields.folderId.placeholder',
                                        )
                                    "
                            ...
                            <small class="form-text text-muted">
                                {{
                                    __(
                                        'user.googleDriveSettings.fields.folderId.helpText',
                                    )
                                }}
                            </small>
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        >
                            {{
                                __(
                                    'user.googleDriveSettings.fields.folderName.label',
                                )
                            }}
                        </label>
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input
                                    ...
                                    :placeholder="
                                        __(
                                            'user.googleDriveSettings.fields.folderName.placeholder',
                                        )
                                    "
                                    dusk="folder-name"
                                />
                    ...
                    <div class="row mb-3">
                        <label class="col-form-label col-sm-3">
                            {{
                                __(
                                    'user.googleDriveSettings.sections.afterImport.label',
                                )
                            }}
                        </label>
                        <div class="col-sm-9">
                            ...
                            >
                                <div class="d-flex align-items-start">
                                    ...
                                    >
                                        ...
                                        >{{
                                            __(
                                                'user.googleDriveSettings.badges.verified',
                                            )
                                        }}
                                    </span>
                                    <span
                                        v-else-if="
                                            getCapability(action.key) === false
                                        "
                                        ...
                                        :title="
                                            __(
                                                'user.googleDriveSettings.badges.mayFailTooltip',
                                            )
                                        "
                                    ...
                                    >
                                        ...
                                        >{{
                                            __(
                                                'user.googleDriveSettings.badges.mayFail',
                                            )
                                        }}
                                    </span>
                                    <span
                                        ...
                                        data-coreui-placement="top"
                                        :title="
                                            getCapabilityNullReason(action.key)
                                        "
                                        dusk="capability-not-tested"
                                    >
                                        {{
                                            __(
                                                'user.googleDriveSettings.badges.notTested',
                                            )
                                        }}
                                    </span>
                                </div>
                    ...
                    <div class="row mb-3">
                        <label class="col-form-label col-sm-3">
                            {{
                                __(
                                    'user.googleDriveSettings.fields.enabled.label',
                                )
                            }}
                        </label>
                        <div class="col-sm-9">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="enabled">
                                    {{
                                        __(
                                            'user.googleDriveSettings.fields.enabled.helpText',
                                        )
                                    }}
                                </label>
                            </div>
                    ...
                    <div class="row mb-3">
                        ...
                        >
                            {{
                                __(
                                    'user.googleDriveSettings.fields.syncInterval.label',
                                )
                            }}
                        </label>
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <span
                                    ...
                                    :title="
                                        __(
                                            'user.googleDriveSettings.fields.syncInterval.tooltip',
                                        )
                                    "
                                >
                                    <i class="fa fa-info-circle"></i>
                    ...
                    <div v-if="hasConfig" class="row mb-3">
                        <label class="col-form-label col-sm-3">
                            {{
                                __(
                                    'user.googleDriveSettings.fields.lastSync.label',
                                )
                            }}
                        </label>
                        <div class="col-sm-9">
                    ...
                    <div v-if="hasConfig && lastError" class="row mb-3">
                        <label class="col-form-label col-sm-3">
                            {{
                                __(
                                    'user.googleDriveSettings.fields.lastError.label',
                                )
                            }}
                        </label>
                        <div class="col-sm-9">
                            ...
                            >
                                ...
                                <div v-if="testResult.success" class="mt-2">
                                    <div>
                                        {{
                                            __(
                                                'user.googleDriveSettings.test.filesFound',
                                                {
            ...
            >
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        >
                            ...
                            >{{
                                hasConfig
                                    ? __(
                                          'user.googleDriveSettings.buttons.update',
                                      )
                                    : __(
                        ...
                        >
                            ...
                            >{{
                                __(
                                    'user.googleDriveSettings.buttons.testConnection',
                                )
                            }}
                        </button>
                        ...
                        >
                            ...
                            >{{
                                __(
                                    'user.googleDriveSettings.buttons.manualSync',
                                )
                            }}
                        </button>
                    ...
                    >
                        ...
                        >{{
                            __(
                                'user.googleDriveSettings.buttons.deleteConfiguration',
                            )
                        }}
                    </button>
                </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="folderBrowserModalLabel" class="modal-title">
                            {{
                                __(
                                    'user.googleDriveSettings.folderBrowser.title',
                                )
                            }}
                        </h5>
                        <button
                    ...
                    <div class="modal-body">
                        ...
                        >
                            ...
                            <p class="mt-2 text-muted">
                                {{
                                    __(
                                        'user.googleDriveSettings.folderBrowser.loading',
                                    )
                                }}
                            </p>
                        </div>
                        <div v-else>
                            <p class="text-muted small mb-3">
                                ...
                                {{
                                    __(
                                        'user.googleDriveSettings.folderBrowser.sharedHint',
                                    )
                                }}
                            </p>
                            <div
                            ...
                            <input
                                ...
                                :placeholder="
                                    __(
                                        'user.googleDriveSettings.folderBrowser.searchPlaceholder',
                                    )
                                "
                            ...
                            >
                                {{
                                    __(
                                        'user.googleDriveSettings.folderBrowser.empty',
                                    )
                                }}
                            </div>
                            <div
                    ...
                    <div class="modal-footer">
                        ...
                        >
                            {{
                                __(
                                    'user.googleDriveSettings.folderBrowser.useFolderButton',
                                )
                            }}
                        </button>
                    </div>
    ...
    const DISPOSITION_ACTIONS = [
        {
            key: 'delete',
            label: __(
                'user.googleDriveSettings.postImportActions.delete.label',
            ),
        },
        {
            key: 'trash',
    ...
    export default {
        ...
        computed: {
            canBrowseFolders() {
                return (
                    this.hasConfig ||
                    Boolean(this.form.service_account_json?.trim())
                );
            },
            canTest() {
                return (
        ...
        methods: {
                ...
                axios
                    ...
                    .then((response) => {
                        if (response.data && response.data.id) {
                            ...
                            this.serviceAccountEmail =
                                response.data.service_account_email;
                            this.form.folder_id = response.data.folder_id || '';
                            this.form.folder_name =
                                response.data.folder_name || '';
                    ...
                    .catch((error) => {
                        if (error.response && error.response.status === 404) {
                            ...
                            console.error(
                                'Failed to load Google Drive config:',
                                error,
                            );
                        }
                    });
            ...
            async fetchFolderName(target) {
                ...
                try {
                    const response = this.configId
                        ? await axios.get(
                              this.route(
                                  'api.v1.google-drive.config.folder-name',
                                  {
                        ...
                        : await axios.post(
                              ...
                              ),
                              {
                                  folder_id: folderId,
                                  service_account_json:
                                      this.form.service_account_json.trim(),
                              },
                          );
            ...
            getCapabilityNullReason(actionKey) {
                ...
                return __(
                    'user.googleDriveSettings.capabilities.notTestedReason',
                );
            },
                    ...
                    .then((response) => {
                        if (
                            ...
                            toastHelpers.showSuccessToast(
                                this.hasConfig
                                    ? __(
                                          'user.googleDriveSettings.toasts.updated',
                                      )
                                    : __(
                                          'user.googleDriveSettings.toasts.created',
                                      ),
                            );
                    ...
                    .catch((error) => {
                        if (error.response && error.response.status === 422) {
                            toastHelpers.showErrorToast(
                                __(
                                    'user.googleDriveSettings.toasts.validationFailed',
                                ),
                            );
                        } else {
                            console.error(error);
                            toastHelpers.showErrorToast(
                                __(
                                    'user.googleDriveSettings.toasts.genericError',
                                ),
                            );
                        }
                    })
            ...
            testConnection() {
                ...
                if (
                    ...
                    testData.processed_folder_id =
                        this.form.processed_folder_id;
                    testData.post_import_actions =
                        this.form.post_import_actions;
                }

                axios
                    .post(
                        this.route('api.v1.google-drive.config.test'),
                        testData,
                    )
                    .then((response) => {
                        this.testResult = {
                            ...
                            message:
                                ...
                                __(
                                    'user.googleDriveSettings.toasts.connectionSuccess',
                                ),
                    ...
                    .catch((error) => {
                        this.testResult = {
                            ...
                            message:
                                ...
                                __(
                                    'user.googleDriveSettings.toasts.connectionFailed',
                                ),
                        };
                    })
                    .finally(() => {
                ...
                axios
                    ...
                    .then((response) => {
                        toastHelpers.showInfoToast(
                            response.data?.message ||
                                __(
                                    'user.googleDriveSettings.toasts.syncQueued',
                                ),
                        );
                    })
                    .catch((error) => {
            ...
            deleteConfig() {
                Swal.fire({
                    ...
                    icon: 'warning',
                    showCancelButton: true,
                    cancelButtonText: this.__(
                        'user.googleDriveSettings.buttons.cancel',
                    ),
                    ...
                    if (result.isConfirmed) {
                        axios
                            .delete(
                                this.route(
                                    'api.v1.google-drive.config.destroy',
                                    {
                                        googleDriveConfig: this.configId,
                                    },
                                ),
                            ...
                            .then(() => {
                                ...
                                toastHelpers.showSuccessToast(
                                    __(
                                        'user.googleDriveSettings.toasts.deleted',
                                    ),
                                );
                            })
                            .catch((error) => {
                                ...
                                toastHelpers.showErrorToast(
                                    __(
                                        'user.googleDriveSettings.toasts.deleteFailed',
                                    ),
                                );
                            });
                    }
            ...
            openFolderBrowser(target) {
                ...
                const folderRequest = this.configId
                    ...
                    : axios.post(
                          this.route(
                              'api.v1.google-drive.config.folders-by-credentials',
                          ),
                          {
                              service_account_json:
                                  this.form.service_account_json.trim(),
                ...
                folderRequest
                    ...
                    .catch((error) => {
                        this.folderBrowserError =
                            error.response?.data?.error?.message ||
                            __(
                                'user.googleDriveSettings.folderBrowser.loadFailed',
                            );
                        this.folderBrowserNotice = null;
                    })
                    .finally(() => {
