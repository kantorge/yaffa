                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button
                            ...
                            class="btn-close"
                            :disabled="
                                creating || (createdToken && !acknowledged)
                            "
                        ...
                        <form v-else @submit.prevent="createToken">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text mb-2">
                                    {{
                                        __(
                                            'Every token can always read your data.',
                                        )
                                    }}
                                </div>
                                <div class="form-check">
                                ...
                                <div class="form-check">
                                    ...
                                    <label
                                        class="form-check-label"
                                        for="apiTokenAbilitySettings"
                                    >
                                        {{
                                            __(
                                                'Allow account & security settings changes',
                                            )
                                        }}
                                    </label>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">
                                    {{
                                        __(
                                            'Leave blank to use the maximum allowed lifetime.',
                                        )
                                    }}
                                </div>
                            </div>
    ...
    export default {
        ...
        methods: {
            ...
            setModalDismissible(dismissible) {
                ...
                this.createModal._config.backdrop = dismissible
                    ? true
                    : 'static';
