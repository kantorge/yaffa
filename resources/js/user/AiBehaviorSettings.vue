        ...
        >
                ...
                <template v-else>
                        ...
                        <div class="col-sm-8">
                            <div class="form-check form-switch">
                                ...
                                >
                                    {{
                                        __(
                                            'Use previous document prompt/response history',
                                        )
                                    }}
                                </label>
                            </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            ...
                            <HasError
                                field="generic_document_language"
                                :form="form"
                            />
                        </div>
                    </div>
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input
                                    ...
                                    v-model.number="
                                        form.asset_similarity_threshold
                                    "
                                    type="number"
                                    class="form-control"
                            ...
                            <HasError
                                field="asset_similarity_threshold"
                                :form="form"
                            />
                        </div>
                    </div>
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input
                                    ...
                                    v-model.number="
                                        form.match_auto_accept_threshold
                                    "
                                    type="number"
                                    class="form-control"
                            ...
                            <HasError
                                field="match_auto_accept_threshold"
                                :form="form"
                            />
                        </div>
                    </div>
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input
                                    ...
                                    v-model.number="
                                        form.duplicate_date_window_days
                                    "
                                    type="number"
                                    class="form-control"
                            ...
                            <HasError
                                field="duplicate_date_window_days"
                                :form="form"
                            />
                        </div>
                    </div>
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input
                                    ...
                                    v-model.number="
                                        form.duplicate_amount_tolerance_percent
                                    "
                                    type="number"
                                    class="form-control"
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input
                                    ...
                                    v-model.number="
                                        form.duplicate_similarity_threshold
                                    "
                                    type="number"
                                    class="form-control"
                            ...
                            <HasError
                                field="duplicate_similarity_threshold"
                                :form="form"
                            />
                        </div>
                    </div>
                    ...
                    <div v-if="tesseractAvailable" class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            ...
                            <HasError
                                field="image_max_width_tesseract"
                                :form="form"
                            />
                        </div>
                    </div>
                    ...
                    <div v-if="tesseractAvailable" class="row mb-0">
                        ...
                        <div class="col-sm-8">
                            ...
                            <HasError
                                field="image_max_height_tesseract"
                                :form="form"
                            />
                        </div>
                    </div>
            ...
            <div v-else class="card-body">
                <div class="alert alert-warning">
                    {{
                        __(
                            'You are in sandbox mode. You cannot change the AI settings.',
                        )
                    }}
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            loadSettings() {
                axios
                    ...
                    .then((response) => {
                        ...
                        this.form.image_quality_vision =
                            data.image_quality_vision ?? null;
                        ...
                        this.$emit(
                            'ai-processing-changed',
                            this.form.ai_enabled,
                        );
                    })
                    .catch((error) => {
                        console.error(
                            'Failed to load AI behavior settings:',
                            error,
                        );
            ...
            async onSubmit() {
                ...
                if (
                    !(await this.confirmRetentionChange(
                        payload.document_retention_days,
                    ))
                ) {
                    return;
                }
                ...
                this.form
                    ...
                    .then((response) => {
                        ...
                        toastHelpers.showSuccessToast(
                            __('AI behavior settings updated'),
                        );
                    })
                    .catch((error) => {
            ...
            async confirmRetentionChange(retentionDays) {
                const driveKeepsFiles =
                    window.aiSettingsPageMeta?.drive_keeps_imported_files ===
                    true;
