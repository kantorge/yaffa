            ...
            <div class="col-sm-9">
                <div class="input-group">
                    ...
                    >
                        <i
                            class="fa"
                            :class="selectedProviderStatusIconClass"
                        ></i>
                    </span>
                </div>
            </div>
        ...
        <div v-if="selectedProvider" class="row mb-3">
            ...
            <div class="col-sm-9">
                <div class="border rounded p-3 bg-body-secondary">
                    ...
                    <p
                        v-if="selectedSettingFields.length === 0"
    ...
    export default {
        ...
        setup(props) {
            ...
            const initializeSettingsForProvider = (providerKey) => {
                ...
                const schema =
                    props.providerOptions?.[providerKey]
                ...
                const oldProviderSettings =
                    props.oldInput?.provider_settings || {};
            ...
            const providerList = computed(() =>
                Object.entries(props.providerOptions || {}).map(
                    ([key, metadata]) => ({
                        key,
                        ...metadata,
            ...
            const providerStatus = (provider) => {
                ...
                if (Array.isArray(provider.reasonFlags)) {
                    return {
                        ...
                        badgeClass: badgeClassForReasonFlags(
                            provider.reasonFlags,
                        ),
                    };
                }

                const requiredFields =
                    provider.userSettingsSchema?.required || [];
            ...
            const loadProviderAvailability = () => {
                return axios
                    ...
                    .then((response) => {
                        providerAvailability.value = Array.isArray(
                            response.data,
                        )
                            ? response.data
                            : [];
            ...
            const getSymbolValue = () => {
                const symbolInput = window.document.getElementById(
                    props.symbolFieldId,
                );
            ...
            const testProviderFetch = async () => {
                ...
                try {
                    const response = await axios.post(
                        window.route(
                            'api.v1.investment-price-providers.test-fetch',
                            {
