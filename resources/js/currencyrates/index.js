            ...
            render: function ( data, type, row, meta ) {
                return '' + /*+
                       ...
                       */
                       ...
                       '<form id="form-delete-' + row.id + '" action="' + route('currency-rate.destroy', row.id) + '" method="POST" style="display: none;"><input type="hidden" name="_method" value="DELETE"><input type="hidden" name="_token" value="' + csrfToken + '"></form>';
            },
            orderable: false
        }
        ],
