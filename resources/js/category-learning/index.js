        ...
        onLearningUpserted(learning) {
            ...
            if (existingIndex !== -1) {
                ...
                toastHelpers.showSuccessToast(
                    __('Category learning entry updated'),
                );
            ...
            tableElement.on('click', '.button-delete-learning', function () {
                ...
                confirmDelete(
                    ...
                    window.axios
                        ...
                        .then(() => {
                            window.categoryLearnings =
                                window.categoryLearnings.filter(
                        ...
                        .catch(() =>
                            toastHelpers.showErrorToast(
                                __(
                                    'Error while deleting category learning entry',
                                ),
                            ),
                        );
                });
...
$('#button-submit-merge-learning').on('click', function () {
    ...
    if (source.length === 0 || target.length === 0) {
        toastHelpers.showErrorToast(
            __(
                'Please select both source and target category learning entries',
            ),
        );
        return;
    }
    ...
    window.axios
        ...
        .then((response) => {
            ...
            mergeModal.hide();
            toastHelpers.showSuccessToast(
                __('Category learning entries merged'),
            );
        })
        .catch((error) => {
            const message =
