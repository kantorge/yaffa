        ...
        <div class="card mb-3">
            ...
            <ul class="list-group list-group-flush collapse show" aria-expanded="true" id="cardActions">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <a href="{{ route('investment-group.create') }}">
                        {{ __('New investment group') }}
                    </a>
                    <a class="btn btn-sm btn-success" dusk="button-new-investment-group"
                        href="{{ route('investment-group.create') }}" title="{{ __('New investment group') }}">
                        <i class="fa fa-plus"></i>
                    </a>
                </li>

                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <a href="{{  route('investment.index') }}">{{ __('Manage investments') }}</a>
                    <a class="btn btn-sm btn-outline-primary" dusk="button-manage-investments"
                        href="{{  route('investment.index') }}" title="{{ __('Manage investments') }}">
