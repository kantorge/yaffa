    ...
    <div class="card">
        <div class="card-header">
            <div class="card-tools">
                <a href="/investmentgroups/create" class="btn btn-success" title="New investment group"><i class="fa fa-plus"></i></a>
            </div>
            <!-- /.card-tools -->
        </div>
        <!-- /.card-header -->
...
@section('js')
    <script>
        var tableData = <?=json_encode($investmentGroups)?>;
        ...
        $(document).ready( function () {
            $('#table').DataTable({
                ...
                {
                    data: "id",
                    title: "{{\App\InvestmentGroup::label('id')}}"
                },
                {
                    data: "name",
                    title: "{{\App\InvestmentGroup::label('name')}}"
                },
                {
                    data: "id",
                    title: "Actions",
