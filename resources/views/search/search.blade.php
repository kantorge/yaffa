                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="accountAction">
                                    <a href="{{ route('transactions.createStandard', ['account_from' => $account->id ]) }}" class="btn btn-sm btn-success" title="{{ __('New transaction') }}"><i class="fa fa-plus"></i></a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="payeeAction">
                                    ...
                                    <a href="{{ route('transactions.createStandard', ['account_to' => $payee->id ]) }}" class="btn btn-sm btn-success" title="New transaction"><i class="fa fa-plus"></i></a>
                                    --}}
                                </td>
                            </tr>
                            @endforeach
