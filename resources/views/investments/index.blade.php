...
@section('js')
    <script>
        var tableData = <?=json_encode($investments)?>;
        ...
        $(document).ready( function () {
            $('#table').DataTable({
                ...
                {
                    data: "id",
                    title: "{{\App\Investment::label('id')}}"
                },
                {
                    data: "name",
                    title: "{{\App\Investment::label('name')}}"
                },
                {
                    data: "active",
                    title: "{{\App\Investment::label('active')}}"
                },
                {
                    data: "symbol",
                    title: "{{\App\Investment::label('symbol')}}"
                },
                {
                    data: "investment_groups.name",
                    title: "{{\App\Investment::label('investment_group')}}"
                },
                {
                    data: "currencies.name",
                    title: "{{\App\Investment::label('currency')}}"
                },
                {
                    data: "id",
                    title: "Actions",
