        ...
        <div class="card mb-3">
            ...
            <ul class="list-group list-group-flush collapse show" aria-expanded="true" id="cardActions">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <a href="{{ route('investments.create') }}">{{ __('New investment') }}</a>
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <a href="{{  route('investment-groups.index') }}">{{ __('Manage investment groups') }}</a>
                    <a class="btn btn-sm btn-outline-primary"
                        id="button-manage-investment-groups"
                        href="{{  route('investment-groups.index') }}" title="{{ __('Manage investment groups') }}">
